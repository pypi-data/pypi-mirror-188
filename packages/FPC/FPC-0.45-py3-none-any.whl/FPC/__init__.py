...
def end():
	print(now('micro')-start_time)
class mysql(object):
	conn=None
	def __init__(self, host=None,**args):
		import pymysql
		self.pymysql=pymysql
		connect_config={'host':'127.0.0.1' if host is None else host,'user':'root','password':'','db':'localhost','charset':'utf8','cursorclass':pymysql.cursors.DictCursor,'autocommit':None}
		if 'table' in args:
