...
setup_kwargs = {
    'name': 'trabalho-individual-2022-2-wesleysantos00',
    'version': '0.1.0',
    'description': 'Sistema que trata de uma biblioteca python para executar pipelines de dados de forma customizável em bancos de dados.',
    ...
    'author': 'wesleysantos00',
    'author_email': 'wesley.sluk@hotmail.com',
    'maintainer': None,
