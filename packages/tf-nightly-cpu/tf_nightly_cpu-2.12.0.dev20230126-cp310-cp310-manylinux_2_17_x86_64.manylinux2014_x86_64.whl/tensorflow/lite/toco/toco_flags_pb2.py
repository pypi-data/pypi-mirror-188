...
_TOCOFLAGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_mlir_variable_quantization', full_name='toco.TocoFlags.enable_mlir_variable_quantization', index=46,
