...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow/tsl/protobuf/distributed_runtime_payloads.proto',
  package='tensorflow.distributed_runtime',
  syntax='proto3',
  serialized_options=_b('Z<github.com/tsl/tsl/go/core/protobuf/for_core_protos_go_proto\370\001\001'),
...
GrpcPayloadContainer = _reflection.GeneratedProtocolMessageType('GrpcPayloadContainer', (_message.Message,), {
  ...
  'PayloadsEntry' : _reflection.GeneratedProtocolMessageType('PayloadsEntry', (_message.Message,), {
    ...
    '__module__' : 'tensorflow.tsl.protobuf.distributed_runtime_payloads_pb2'
