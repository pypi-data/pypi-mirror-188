...
class TensorProto :
 ...
 public:
  ...
  void set_float8_val(const std::string& value);
  void set_float8_val(std::string&& value);
  void set_float8_val(const char* value);
  void set_float8_val(const void* value, size_t size);
  std::string* mutable_float8_val();
  std::string* release_float8_val();
  void set_allocated_float8_val(std::string* float8_val);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_float8_val();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_float8_val(
      std::string* float8_val);
...
inline void TensorProto::clear_float8_val() {
  float8_val_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline const std::string& TensorProto::float8_val() const {
  // @@protoc_insertion_point(field_get:tensorflow.TensorProto.float8_val)
  return float8_val_.Get();
}
inline void TensorProto::set_float8_val(const std::string& value) {
  
  float8_val_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:tensorflow.TensorProto.float8_val)
}
inline void TensorProto::set_float8_val(std::string&& value) {
  
  float8_val_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.TensorProto.float8_val)
}
inline void TensorProto::set_float8_val(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  float8_val_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:tensorflow.TensorProto.float8_val)
}
inline void TensorProto::set_float8_val(const void* value,
    size_t size) {
  
  float8_val_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:tensorflow.TensorProto.float8_val)
}
inline std::string* TensorProto::mutable_float8_val() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.TensorProto.float8_val)
  return float8_val_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline std::string* TensorProto::release_float8_val() {
  // @@protoc_insertion_point(field_release:tensorflow.TensorProto.float8_val)
  
  return float8_val_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void TensorProto::set_allocated_float8_val(std::string* float8_val) {
  ...
  float8_val_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), float8_val,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:tensorflow.TensorProto.float8_val)
}
inline std::string* TensorProto::unsafe_arena_release_float8_val() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorflow.TensorProto.float8_val)
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  
  return float8_val_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void TensorProto::unsafe_arena_set_allocated_float8_val(
    std::string* float8_val) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  if (float8_val != nullptr) {
  ...
  float8_val_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      float8_val, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorflow.TensorProto.float8_val)
}
