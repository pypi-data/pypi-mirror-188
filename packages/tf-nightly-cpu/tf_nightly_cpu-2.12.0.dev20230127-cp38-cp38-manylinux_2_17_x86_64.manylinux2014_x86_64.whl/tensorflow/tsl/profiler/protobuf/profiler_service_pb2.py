...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow/tsl/profiler/protobuf/profiler_service.proto',
  package='tensorflow',
  syntax='proto3',
  ...
  ,
  dependencies=[tensorflow_dot_tsl_dot_profiler_dot_protobuf_dot_profiler__options__pb2.DESCRIPTOR,tensorflow_dot_tsl_dot_profiler_dot_protobuf_dot_profiler__service__monitor__result__pb2.DESCRIPTOR,])
...
_PROFILEREQUEST.fields_by_name['opts'].message_type = tensorflow_dot_tsl_dot_profiler_dot_protobuf_dot_profiler__options__pb2._PROFILEOPTIONS
_PROFILERESPONSE.fields_by_name['tool_data'].message_type = _PROFILETOOLDATA
_MONITORRESPONSE.fields_by_name['monitor_result'].message_type = tensorflow_dot_tsl_dot_profiler_dot_protobuf_dot_profiler__service__monitor__result__pb2._PROFILERSERVICEMONITORRESULT
...
ToolRequestOptions = _reflection.GeneratedProtocolMessageType('ToolRequestOptions', (_message.Message,), {
  ...
  '__module__' : 'tensorflow.tsl.profiler.protobuf.profiler_service_pb2'
