...
async def get_account_by_id(request: web.Request) -> (DesktopObjectDict | None, str | None):
    """
    ...
    async def get_account_and_volume_id(account_getter: Awaitable[DesktopObjectDict | None],
                                        volume_id_: str | None) -> (DesktopObjectDict | None, str | None):
        """
...
def _get_folder(bucket_name: str, contents: Dict[str, Any], key: str, encoded_key: str, request: Request) -> AWSS3Folder:
    folder = AWSS3Folder()
