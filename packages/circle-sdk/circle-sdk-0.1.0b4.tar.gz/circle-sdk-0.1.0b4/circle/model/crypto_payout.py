...
class CryptoPayout(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sourceWalletId", "destination", "amount", "toAmount", "fees", "status", "errorCode", "riskEvaluation", "createDate", "updateDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sourceWalletId", "destination", "amount", "toAmount", "fees", "status", "errorCode", "riskEvaluation", "createDate", "updateDate", ], str]):
