...
class BusinessRecipientAddressObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "address", "addressTag", "chain", "currency", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "address", "addressTag", "chain", "currency", "description", ], str]):
