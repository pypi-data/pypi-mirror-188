...
class AddressObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "addressTag", "currency", "chain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "addressTag", "currency", "chain", ], str]):
