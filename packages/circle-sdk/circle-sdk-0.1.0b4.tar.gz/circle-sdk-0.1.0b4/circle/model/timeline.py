...
class Timeline(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "time", "context", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "time", "context", ], str]):
