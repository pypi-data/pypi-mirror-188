...
class BasicChargeback(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class history(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BasicChargebackHistory'], typing.List['BasicChargebackHistory']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "paymentId", "merchantId", "reasonCode", "history", "category", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "paymentId", "merchantId", "reasonCode", "history", "category", ], str]):
