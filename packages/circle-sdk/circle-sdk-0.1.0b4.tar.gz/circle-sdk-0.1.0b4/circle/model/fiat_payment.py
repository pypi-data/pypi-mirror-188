...
class FiatPayment(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class refunds(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PaymentInfoPaymentAndRefund'], typing.List['PaymentInfoPaymentAndRefund']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "merchantId", "amount", "source", "status", "merchantWalletId", "description", "captured", "captureAmount", "captureDate", "requiredAction", "cancel", "refunds", "fees", "channel", "createDate", "updateDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "merchantId", "amount", "source", "status", "merchantWalletId", "description", "captured", "captureAmount", "captureDate", "requiredAction", "cancel", "refunds", "fees", "channel", "createDate", "updateDate", ], str]):
