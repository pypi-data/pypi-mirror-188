...
# body param
SchemaForRequestBodyApplicationJson = MockChargebackCreationRequest


request_body_mock_chargeback_creation_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CreateMockChargebackResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_mock_chargeback_oapg(
        self,
    ...
    def _create_mock_chargeback_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_mock_chargeback_creation_request.serialize(body, content_type)
...
class CreateMockChargeback(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_mock_chargeback(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_mock_chargeback(
        ...
        return self._create_mock_chargeback_oapg(
            body=body,
