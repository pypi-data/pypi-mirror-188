...
SchemaFor200ResponseBodyApplicationJson = GetAddressBookRecipient
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_address_book_recipient_oapg(
        self,
...
class GetAddressBookRecipient(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_address_book_recipient(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_address_book_recipient(
        ...
        return self._get_address_book_recipient_oapg(
