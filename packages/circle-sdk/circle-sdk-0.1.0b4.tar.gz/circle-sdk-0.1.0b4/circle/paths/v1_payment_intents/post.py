...
# body param
SchemaForRequestBodyApplicationJson = PaymentIntent


request_body_payment_intent = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CreatePaymentIntentResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_payment_intent_oapg(
        self,
    ...
    def _create_payment_intent_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_payment_intent.serialize(body, content_type)
...
class CreatePaymentIntent(BaseApi):
    ...
    def create_payment_intent(
        ...
        return self._create_payment_intent_oapg(
            body=body,
