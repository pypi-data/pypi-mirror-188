...
SchemaFor200ResponseBodyApplicationJson = ListPaymentIntentsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_payment_intents_oapg(
        self,
...
class ListPaymentIntents(BaseApi):
    ...
    def list_payment_intents(
        ...
        return self._list_payment_intents_oapg(
