...
# body param
SchemaForRequestBodyApplicationJson = AddressBookRecipientRequest


request_body_address_book_recipient_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CreateAddressBookRecipientResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_address_book_recipient_oapg(
        self,
    ...
    def _create_address_book_recipient_oapg(
        ...
        """
        Create a an address book recipient
        ...
        if body is not schemas.unset:
            serialized_data = request_body_address_book_recipient_request.serialize(body, content_type)
...
class CreateAddressBookRecipient(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_address_book_recipient(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_address_book_recipient(
        ...
        return self._create_address_book_recipient_oapg(
            body=body,
