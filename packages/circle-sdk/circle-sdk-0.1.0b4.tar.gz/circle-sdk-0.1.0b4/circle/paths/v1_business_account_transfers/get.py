...
SchemaFor200ResponseBodyApplicationJson = ListBusinessTransfersResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_business_transfers_oapg(
        self,
...
class ListBusinessTransfers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_business_transfers(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_business_transfers(
        ...
        return self._list_business_transfers_oapg(
