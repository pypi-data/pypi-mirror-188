...
SchemaFor201ResponseBodyApplicationJson = ExpirePaymentIntentResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _expire_payment_intent_oapg(
        self,
...
class ExpirePaymentIntent(BaseApi):
    ...
    def expire_payment_intent(
        ...
        return self._expire_payment_intent_oapg(
            body=body,
