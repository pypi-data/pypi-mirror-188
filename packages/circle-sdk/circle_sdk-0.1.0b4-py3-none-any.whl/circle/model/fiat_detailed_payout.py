...
class FiatDetailedPayout(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sourceWalletId", "destination", "amount", "fees", "status", "trackingRef", "externalRef", "errorCode", "riskEvaluation", "adjustments", "return", "createDate", "updateDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sourceWalletId", "destination", "amount", "fees", "status", "trackingRef", "externalRef", "errorCode", "riskEvaluation", "adjustments", "return", "createDate", "updateDate", ], str]):
