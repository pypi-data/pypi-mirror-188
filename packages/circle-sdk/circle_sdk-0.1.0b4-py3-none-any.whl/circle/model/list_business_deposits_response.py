...
class ListBusinessDepositsResponse(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BusinessDeposit']:
                        return BusinessDeposit
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BusinessDeposit'], typing.List['BusinessDeposit']],
                ...
                def __getitem__(self, i: int) -> 'BusinessDeposit':
