...
# body param
SchemaForRequestBodyApplicationJson = AddressBookRecipientPatchRequest


request_body_address_book_recipient_patch_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PatchAddressBookRecipientResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_address_book_recipient_oapg(
        self,
    ...
    def _patch_address_book_recipient_oapg(
        ...
        """
        Patch an address book recipient
        ...
        if body is not schemas.unset:
            serialized_data = request_body_address_book_recipient_patch_request.serialize(body, content_type)
...
class PatchAddressBookRecipient(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_address_book_recipient(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_address_book_recipient(
        ...
        return self._patch_address_book_recipient_oapg(
            body=body,
