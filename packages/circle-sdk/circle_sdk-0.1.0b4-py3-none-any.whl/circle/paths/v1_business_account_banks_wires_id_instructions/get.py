...
SchemaFor200ResponseBodyApplicationJson = GetBusinessWireAccountInstructionsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_business_wire_account_instructions_oapg(
        self,
...
class GetBusinessWireAccountInstructions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_business_wire_account_instructions(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_business_wire_account_instructions(
        ...
        return self._get_business_wire_account_instructions_oapg(
