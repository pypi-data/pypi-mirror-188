...
# Query params
PaymentIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'paymentId': typing.Union[PaymentIdSchema, str, uuid.UUID, ],
...
request_query_payment_id = api_client.QueryParameter(
    name="paymentId",
...
SchemaFor200ResponseBodyApplicationJson = ListChargebacksResponse
...
class ListChargebacks(BaseApi):
    ...
    def list_chargebacks(
        ...
        return self._list_chargebacks_oapg(
