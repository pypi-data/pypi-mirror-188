...
# body param
SchemaForRequestBodyApplicationJson = CardUpdate


request_body_card_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UpdateCardResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_card_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_card_update.serialize(body, content_type)
