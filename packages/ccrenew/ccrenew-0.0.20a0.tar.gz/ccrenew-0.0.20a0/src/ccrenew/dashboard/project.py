...
class Project:
    ...
    def calculate_native_sensor_averages(self):
    ...
    def calculate_sensor_average_data_sub(self, neighbor_sensor_avgs: dict = {}, get_solcast=False):
        """
        ...
        if self.df_sensors_native_avg.empty:
            self.calculate_native_sensor_averages()
