...
class DataMongodbatlasServerlessInstance(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/mongodbatlas/d/serverless_instance#name DataMongodbatlasServerlessInstance#name}.
        :param project_id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/mongodbatlas/d/serverless_instance#project_id DataMongodbatlasServerlessInstance#project_id}.
        :param continuous_backup_enabled: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/mongodbatlas/d/serverless_instance#continuous_backup_enabled DataMongodbatlasServerlessInstance#continuous_backup_enabled}.
        :param links: links block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/mongodbatlas/d/serverless_instance#links DataMongodbatlasServerlessInstance#links}
        :param state_name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/mongodbatlas/d/serverless_instance#state_name DataMongodbatlasServerlessInstance#state_name}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataMongodbatlasServerlessInstanceLinksOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataMongodbatlasServerlessInstanceLinks, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataMongodbatlasServerlessInstanceLinks, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataMongodbatlasServerlessInstanceLinks, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
