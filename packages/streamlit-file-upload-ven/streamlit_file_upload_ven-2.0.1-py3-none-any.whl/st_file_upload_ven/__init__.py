...
def file_upload_ven(name, isUploaded, key=None):
    component_value = _component_func(name=name, isUploaded=isUploaded, key=key, default=0)
...
if not _RELEASE:
    ...
    uploaded_file = file_upload_ven(["World","Hello","Test"], False)
