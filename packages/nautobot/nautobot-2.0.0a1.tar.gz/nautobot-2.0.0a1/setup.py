...
['Django>=3.2.16,<3.3.0',
 ...
 'django-taggit>=3.1.0,<3.2.0',
 'django-timezone-field>=4.1.2,<4.2.0',
 'django-tree-queries>=0.13.0,<0.14.0',
 'django-webserver>=1.2.0,<1.3.0',
 'djangorestframework>=3.14.0,<3.15.0',
 'drf-spectacular[sidecar]>=0.25.0,<0.26.0',
...
{':python_version < "3.8"': ['importlib-metadata>=4.4,<5.0'],
 ...
 'remote-storage': ['django-storages>=1.13.0,<1.14.0'],
