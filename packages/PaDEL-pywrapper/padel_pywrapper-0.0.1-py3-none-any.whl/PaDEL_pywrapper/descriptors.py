...
#
#
# class CDK_KierHallSmartsDescriptor(Descriptor):
#     def __init__(self):
#         super().__init__(False)
#
#     @property
#     def descriptor(self):
#         if not hasattr(self, '_descriptor'):
#             self._descriptor = self.padel.CDK_KierHallSmartsDescriptor()
#         return self._descriptor
...
# class eCDK_LingoFingerprinter(Descriptor):
#     @property
#     def descriptor(self):
#         if not hasattr(self, '_descriptor'):
#             self._descriptor = self.epadel.eCDK_LingoFingerprinter()
#         return self._descriptor
#
#     def set_params(self, params: Dict[str, int] = {'substring_length': 4}):
#         default = {'substring_length': 4}
#         default.update(params)
#         self._descriptor = self.epadel.eCDK_ExtendedFingerprinter(default['substring_length'])
#
#
# class eCDK_ShortestPathFingerprinter(Descriptor):
#     @property
#     def descriptor(self):
#         if not hasattr(self, '_descriptor'):
#             self._descriptor = self.epadel.eCDK_ShortestPathFingerprinter()
#         return self._descriptor
#
#
# class eCDK_SignatureFingerprinter(Descriptor):
#     @property
#     def descriptor(self):
#         if not hasattr(self, '_descriptor'):
#             self._descriptor = self.epadel.eCDK_SignatureFingerprinter()
#         return self._descriptor
#
#     def set_params(self, params: Dict[str, int] = {'depth': 1}):
#         default = {'depth': 1}
#         default.update(params)
#         self._descriptor = self.epadel.eCDK_ExtendedFingerprinter(default['depth'])
#
#
...
_fingerprints = [eCDK_Fingerprinter,
                 ...
                 # eCDK_LingoFingerprinter,
                 # eCDK_ShortestPathFingerprinter,
                 # eCDK_SignatureFingerprinter
                 ]
...
# LingoFingerprint = _fingerprints[12]
# ShortestPathFingerprint = _fingerprints[13]
# SignatureFingerprint = _fingerprints[14]
