...
class KernelForceResetAdditionalInfo(KernelSpecificBase, KernelSpecificPanic):
    ...
    def __init__(self, data: str):
        ...
        self.__backtrace = Backtrace(panic_infos, "Kernel Extensions in backtrace", self.sliders.kernel_cache_slide)
        self.parse_additional_info(additional_info_lines, self.sliders.kernel_cache_slide)
    ...
    def parse_additional_info(self, additional_info_lines: [str], kernel_cache_slide: hex):
