...
class _HelpCommandImplementation(Command):
    """Class that interfaces with :class:`Octrapy.ext.commands.Command`."""
...
class HelpCommand:
    ...
    Attributes
    ----------
    ctx: :class:`Octrapy.ext.commands.Context`
        The :class:`Octrapy.ext.commands.Context` for the command
    bot: :class:`Octrapy.ext.commands.Bot`
        The :class:`Octrapy.ext.commands.Bot` from the Context
    """
...
class DefaultHelpCommand(HelpCommand):
    ...
    async def format_commands(self, commands: typing.List[Command], *, heading: str):
        ...
        Parameters
        ----------
        commands: List[:class`Octrapy.ext.commands.Command`]
