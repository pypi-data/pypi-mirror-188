...
class Bot(Octrapy.Client):
    """
    Represents a Octra bot.
    ...
    owner_ids: Optional[List[:class:`int`]]
        The owner IDs.
    help_command: Optional[:class:`Octrapy.ext.commands.HelpCommand`]
        The bot's help command.
        Defaults to :class:`Octrapy.ext.commands.DefaultHelpCommand`
    ...
    owner_ids: Optional[List[:class:`int`]]
        The owner IDs.
    cogs: Mapping[:class:`str`: :class:`Octrapy.ext.commands.Cog`]
    ...
    def help_command(self):
        """:class:`Octrapy.ext.commands.HelpCommand`:
            The bot's help command.
        """
    ...
    def get_command(self, name: str):
        ...
        Returns
        --------
        :class:`Octrapy.ext.commands.Command`
    ...
    async def get_context(self, message: Octrapy.Message):
        """
        ...
        Returns
        -------
        :class:`Octrapy.ext.commands.Context`
            The context created.

        Raises
        ------
        :class:`Octrapy.ext.commands.CommandNotFound`
    ...
    def load_extension(self, location: str):
        ...
        Raises
        ------
        :exc:`Octrapy.ExtensionAlreadyLoaded`
    ...
    def add_cog(self, cog: Cog):
        ...
        Parameters
        ----------
        cog: :class:`Octrapy.ext.commands.Cog`
            The cog to add.

        Raises
        ------
        :exc:`TypeError`
            The cog is not a subclass of :class:`Octrapy.ext.commands.Cog` or the cog check is not a method.
        """
    ...
    def add_command(self, command):
        ...
        Parameters
        ----------
        command: :class:`Octrapy.ext.commands.Command`
            The command to add.
        ...
        Raises
        ------
        :exc:`Octrapy.ext.commands.CommandRegistrationError`
            The command name or one if its aliases is already registered by a different command.
        :exc:`TypeError`
            The command is not an instance of :class:`Octrapy.ext.commands.Command`.
        """
