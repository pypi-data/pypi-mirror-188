...
class LayerProps:
    def __init__(
        ...
        *,
        ...
        '''
        :param always_rebuild: (experimental) Always rebuild the layer, even when the depdencies definition files haven't changed. Default: false
    ...
    def always_rebuild(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Always rebuild the layer, even when the depdencies definition files haven't changed.
