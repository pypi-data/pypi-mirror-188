...
class Sale(Commodity):
    accounts = []
    def __init__(self, customer,commodity, fair_value,market_price, supply, demand, quantity, unit_price,date):
        super().__init__(commodity, fair_value,market_price, supply, demand)
...
class Revenue(Sale):
    accounts = []
    def __init__(self, credit,customer,commodity, fair_value,market_price, supply, demand, quantity, unit_price,date):
        super().__init__(customer,commodity, fair_value,market_price, supply, demand, quantity, unit_price,date)
        self.credit=credit
 ...
 # 企业就该商品享有现时收款权利，即客户就该商品负有现时付款义务
    ...
    def generate_receivable(self,consideration,due_date):
        b = AccountsReceivable(self.commodity, [self.quantity * self.unit_price],self.date,self.customer,consideration,[self.quantity * self.unit_price],due_date)
        return b
class RevenueRule:
