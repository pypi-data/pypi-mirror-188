...
class RealState(FixedAsset):
    pass
def main():
    a12=FixedAsset("zhang1",11500,"2022-02-21",costs=Costs(purchase_price=1000, taxes=100,transportation_costs=200, installation_costs=300, professional_services_costs=400),5,"beijing")
    print(a12.debit)
    print(a12.location)
    print(a12.likely_economic_benefit)
    a22=FixedAsset("zhang1",11500,"2022-02-21",costs=Costs(purchase_price=1000, taxes=100,transportation_costs=200, installation_costs=300, professional_services_costs=400),5,"beijing")
    a22.depreciate(0.2)
