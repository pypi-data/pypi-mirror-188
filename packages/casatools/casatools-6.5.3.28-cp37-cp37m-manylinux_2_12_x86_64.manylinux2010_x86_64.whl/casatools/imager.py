...
##################### 8e01f81839ea98cfd3f965f2b2ad6edb ##############################
...
class imager:
    ...
    def advise(self, takeadvice=True, amplitudeloss=float(0.05), fieldofview=[ ]):
        ...
        """
        return self._swigobj.advise(takeadvice, amplitudeloss, fieldofview)
    ...
    def advisechansel(self, freqstart=float(1.0e6), freqend=float(1.1e6), freqstep=float(100.0), freqframe='LSRK', msname='', fieldid=int(0), getfreqrange=False, spwselection=''):
        ...
        """
        return self._swigobj.advisechansel(freqstart, freqend, freqstep, freqframe, msname, fieldid, getfreqrange, spwselection)
    ...
    def approximatepsf(self, psf=''):
        ...
        """
        return self._swigobj.approximatepsf(psf)
    ...
    def boxmask(self, mask='', blc=[ int(0),int(0),int(0),int(0) ], trc=[  ], value=float(1.0)):
        ...
        this requirement.
        """
        return self._swigobj.boxmask(mask, blc, trc, value)
    ...
    def calcuvw(self, fields=[ int(-1) ], refcode='', reuse=True):
        ...
        """
        return self._swigobj.calcuvw(fields, refcode, reuse)
    ...
    def clean(self, algorithm='clark', niter=int(1000), gain=float(0.1), threshold=[ ], displayprogress=False, model=[  ], keepfixed=[ bool(False) ], complist='', mask=[  ], image=[  ], residual=[  ], psfimage=[  ], interactive=False, npercycle=int(100), masktemplate=''):
        ...
        """
        return self._swigobj.clean(algorithm, niter, gain, threshold, displayprogress, model, keepfixed, complist, mask, image, residual, psfimage, interactive, npercycle, masktemplate)
    ...
    def clipimage(self, image='', threshold=[ ]):
        ...
        threshold.
        """
        return self._swigobj.clipimage(image, threshold)
    ...
    def clipvis(self, threshold=[ ]):
        ...
        data.
        """
        return self._swigobj.clipvis(threshold)
    ...
    def defineimage(self, nx=int(128), ny=int(-1), cellx=[ ], celly=[ ], stokes='I', phasecenter=[ ], mode='mfs', nchan=int(-1), start=[ ], step=[ ], spw=[ int(0) ], restfreq=[ ], outframe='LSRK', veltype='radio', facets=int(1), movingsource=[ ], distance=[ ], projection='SIN'):
        ...
        """
        return self._swigobj.defineimage(nx, ny, cellx, celly, stokes, phasecenter, mode, nchan, start, step, spw, restfreq, outframe, veltype, facets, movingsource, distance, projection)
    ...
    def drawmask(self, image='', mask='', niter=int(0), npercycle=int(0), threshold='0 mJy'):
        ...
        """
        return self._swigobj.drawmask(image, mask, niter, npercycle, threshold)
    ...
    def exprmask(self, mask='', expr=float(1.0)):
        ...
        """
        return self._swigobj.exprmask(mask, expr)
    ...
    def feather(self, image='', highres='', lowres='', lowpsf='', effdishdiam=float(-1.0), lowpassfiltersd=False):
        ...
        """
        return self._swigobj.feather(image, highres, lowres, lowpsf, effdishdiam, lowpassfiltersd)
    ...
    def filter(self, type='gaussian', bmaj=[ ], bmin=[ ], bpa=[ ]):
        ...
        imager.fitpsf.
        """
        return self._swigobj.filter(type, bmaj, bmin, bpa)
    ...
    def fitpsf(self, psf):
        ...
        """
        return self._swigobj.fitpsf(psf)
    ...
    def fixvis(self, fields=[ int(-1) ], phasedirs=[  ], refcode='', distances=[ float(0.0) ], datacolumn='all'):
        ...
        """
        return self._swigobj.fixvis(fields, phasedirs, refcode, distances, datacolumn)
    ...
    def ft(self, model=[  ], complist='', incremental=False, phasecentertime=float(-1.0)):
        ...
        """
        return self._swigobj.ft(model, complist, incremental, phasecentertime)
    ...
    def getweightgrid(self, type='imaging', wgtimages=[  ]):
        ...
        """
        return self._swigobj.getweightgrid(type, wgtimages)
    ...
    def linearmosaic(self, images=[  ], mosaic='', fluxscale='', sensitivity='', fieldids=[ int(0) ], usedefaultvp=True, vptable=''):
        ...
        """
        return self._swigobj.linearmosaic(images, mosaic, fluxscale, sensitivity, fieldids, usedefaultvp, vptable)
    ...
    def make(self, image=''):
        ...
        vector of strings.
        """
        return self._swigobj.make(image)
    ...
    def predictcomp(self, objname='', standard='', epoch=[ ], freqs=[ float(1.0e11) ], pfx='predictcomp'):
        ...
        """
        return self._swigobj.predictcomp(objname, standard, epoch, freqs, pfx)
    ...
    def makeimage(self, type='observed', image='', compleximage='', verbose=True):
        ...
        """
        return self._swigobj.makeimage(type, image, compleximage, verbose)
    ...
    def makemodelfromsd(self, sdimage='', modelimage='', sdpsf='', maskimage=''):
        ...
        """
        return self._swigobj.makemodelfromsd(sdimage, modelimage, sdpsf, maskimage)
    ...
    def mask(self, image='', mask='', threshold=[ ]):
        ...
        """
        return self._swigobj.mask(image, mask, threshold)
    ...
    def mem(self, algorithm='entropy', niter=int(20), sigma=[ ], targetflux=[ ], constrainflux=False, displayprogress=False, model=[  ], keepfixed=[ bool(False) ], complist='', prior=[  ], mask=[  ], image=[  ], residual=[  ]):
        ...
        may be acceptable.
        """
        return self._swigobj.mem(algorithm, niter, sigma, targetflux, constrainflux, displayprogress, model, keepfixed, complist, prior, mask, image, residual)
    ...
    def nnls(self, model=[  ], keepfixed=[ bool(False) ], complist='', niter=int(0), tolerance=float(1e-06), fluxmask=[  ], datamask=[  ], image=[  ], residual=[  ]):
        ...
        """
        return self._swigobj.nnls(model, keepfixed, complist, niter, tolerance, fluxmask, datamask, image, residual)
    ...
    def open(self, thems='', compress=False, usescratch=False):
        ...
        the data selection.
        """
        return self._swigobj.open(thems, compress, usescratch)
    ...
    def pb(self, inimage='', outimage='', incomps='', outcomps='', operation='apply', pointingcenter=[ ], parangle=[ ], pborvp='pb'):
        ...
        """
        return self._swigobj.pb(inimage, outimage, incomps, outcomps, operation, pointingcenter, parangle, pborvp)
    ...
    def plotvis(self, type='all', increment=int(1)):
        ...
        """
        return self._swigobj.plotvis(type, increment)
    ...
    def regionmask(self, mask='', region={ }, boxes=[ ], circles=[ ], value=float(1.0)):
        ...
        """
        return self._swigobj.regionmask(mask, region, boxes, circles, value)
    ...
    def regiontoimagemask(self, mask='', region={ }, boxes=[ ], circles=[ ], value=float(1.0)):
        ...
        """
        return self._swigobj.regiontoimagemask(mask, region, boxes, circles, value)
    ...
    def residual(self, model=[  ], complist='', image=[  ]):
        ...
        """
        return self._swigobj.residual(model, complist, image)
    ...
    def restore(self, model=[  ], complist='', image=[  ], residual=[  ]):
        ...
        parameters.
        """
        return self._swigobj.restore(model, complist, image, residual)
    ...
    def updateresidual(self, model=[  ], complist='', image=[  ], residual=[  ]):
        ...
        """
        return self._swigobj.updateresidual(model, complist, image, residual)
    ...
    def setbeam(self, bmaj=[ ], bmin=[ ], bpa=[ ]):
        ...
        operations.
        """
        return self._swigobj.setbeam(bmaj, bmin, bpa)
    ...
    def selectvis(self, vis='', nchan=[ int(-1) ], start=[ int(0) ], step=[ int(1) ], spw=[ ], field=[ ], baseline=[ ], time=[ ], scan=[ ], intent='', observation=[ ], uvrange=[ ], taql='', usescratch=False, datainmemory=False, writeaccess=True):
        ...
        """
        return self._swigobj.selectvis(vis, nchan, start, step, spw, field, baseline, time, scan, intent, observation, uvrange, taql, usescratch, datainmemory, writeaccess)
    ...
    def setjy(self, field=[ ], spw=[ ], modimage='', fluxdensity=[ float(0.0),float(0.0),float(0.0),float(0.0) ], standard='SOURCE', scalebychan=False, spix=[ float(0.0) ], reffreq=[ ], polindex=[ float(0.0) ], polangle=[ float(0.0) ], rotmeas=float(0.0), time='', scan='', intent='', observation='', interpolation='nearest'):
        ...
        """
        return self._swigobj.setjy(field, spw, modimage, fluxdensity, standard, scalebychan, spix, reffreq, polindex, polangle, rotmeas, time, scan, intent, observation, interpolation)
    ...
    def setmfcontrol(self, cyclefactor=float(1.5), cyclespeedup=float(-1), cyclemaxpsffraction=float(0.8), stoplargenegatives=int(2), stoppointmode=int(-1), minpb=float(0.1), scaletype='NONE', constpb=float(0.4), fluxscale=[  ], flatnoise=True):
        ...
        """
        return self._swigobj.setmfcontrol(cyclefactor, cyclespeedup, cyclemaxpsffraction, stoplargenegatives, stoppointmode, minpb, scaletype, constpb, fluxscale, flatnoise)
    ...
    def setoptions(self, ftmachine='ft', cache=int(-1), tile=int(16), gridfunction='SF', location=[ ], padding=float(1.0), freqinterp='nearest', wprojplanes=int(-1), epjtablename='', applypointingoffsets=False, dopbgriddingcorrections=True, cfcachedirname='', rotpastep=float(5.0), pastep=float(360.0), pblimit=float(0.05), imagetilevol=int(0), singleprecisiononly=False, numthreads=int(-1), psterm=True, aterm=True, mterm=True, wbawp=False, conjbeams=True):
        ...
        """
        return self._swigobj.setoptions(ftmachine, cache, tile, gridfunction, location, padding, freqinterp, wprojplanes, epjtablename, applypointingoffsets, dopbgriddingcorrections, cfcachedirname, rotpastep, pastep, pblimit, imagetilevol, singleprecisiononly, numthreads, psterm, aterm, mterm, wbawp, conjbeams)
    ...
    def setscales(self, scalemethod='nscales', nscales=int(5), uservector=[ float(0.0),float(3.0),float(10.0) ]):
        ...
        first value is zero.
        """
        return self._swigobj.setscales(scalemethod, nscales, uservector)
    ...
    def setsdoptions(self, scale=float(1.0), weight=float(1.0), convsupport=int(-1), pointingcolumntouse='DIRECTION', truncate=[ ], gwidth=[ ], jwidth=[ ], minweight=float(0.), clipminmax=False, enablecache=False):
        ...
        """
        return self._swigobj.setsdoptions(scale, weight, convsupport, pointingcolumntouse, truncate, gwidth, jwidth, minweight, clipminmax, enablecache)
    ...
    def setvp(self, dovp=False, usedefaultvp=True, vptable='', dosquint=False, parangleinc=[ ], skyposthreshold=[ ], telescope='', verbose=True):
        ...
        """
        return self._swigobj.setvp(dovp, usedefaultvp, vptable, dosquint, parangleinc, skyposthreshold, telescope, verbose)
    ...
    def setweightgrid(self, weight=[ ], type='imaging'):
        ...
        are parallelizing at the scripting level.
        """
        return self._swigobj.setweightgrid(weight, type)
    ...
    def smooth(self, model=[  ], image=[  ], usefit=True, bmaj=[ ], bmin=[ ], bpa=[ ], normalize=True):
        ...
        not normalized.
        """
        return self._swigobj.smooth(model, image, usefit, bmaj, bmin, bpa, normalize)
    ...
    def weight(self, type='natural', rmode='none', noise=[ ], robust=float(0.0), fieldofview=[ ], npixels=int(0), mosaic=False):
        ...
        """
        return self._swigobj.weight(type, rmode, noise, robust, fieldofview, npixels, mosaic)

    def mapextent(self, ref='J2000', movingsource='', pointingcolumntouse='DIRECTION'):
        """TODO: description must be filled
        """
        return self._swigobj.mapextent(ref, movingsource, pointingcolumntouse)
    ...
    def pointingsampling(self, pattern='raster', ref='J2000', movingsource='', pointingcolumntouse='DIRECTION', antenna=''):
        ...
        """
        return self._swigobj.pointingsampling(pattern, ref, movingsource, pointingcolumntouse, antenna)
