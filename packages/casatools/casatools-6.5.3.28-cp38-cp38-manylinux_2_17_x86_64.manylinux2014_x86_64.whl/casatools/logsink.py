...
##################### 552827bafe005bacb08ace3827d2cc12 ##############################
...
class logsink:
    ...
    def __init__(self, filename='casa.log', enable_telemetry=False, telemetry_logfile='false', *args, **kwargs):
        ...
        if self._swigobj is None:
            self._swigobj = _logsink(_pc.document['filename'], _pc.document['enable_telemetry'], _pc.document['telemetry_logfile'])
    ...
    def poststat(self, message, origin=''):
        ...
        """
        return self._swigobj.poststat(message, origin)
    ...
    def getstatslogfile(self):
        ...
        """
        return self._swigobj.getstatslogfile()
    ...
    def setstatslogfile(self, filename='casapy.log'):
        """
        """
        return self._swigobj.setstatslogfile(filename)
