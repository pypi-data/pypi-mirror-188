...
# Try an embedded cerberus in casatools.
# If that fails use a global cerberus installation
try:
...
class CasaValidator(Validator):
    ...
    def _validate_type_cPyObj(self,value):
        return True
    ...
    def _validate_type_cimageTool(self,value):
        if isinstance(value,casatools.image):
            return True

    def _validate_type_ctablerowTool(self,value):
        if isinstance(value,casatools.tablerow):
            return True

    def _validate_type_cmsmetadataTool(self,value):
        if isinstance(value,casatools.msmetadata):
            return True

    def _validate_type_csynthesisimstoreTool(self,value):
        if isinstance(value,casatools.synthesisimstore):
            return True

    def _validate_type_ccoordsysTool(self,value):
        if isinstance(value,casatools.coordsys):
            return True

    def _validate_type_ctableTool(self,value):
        if isinstance(value,casatools.table):
            return True

    def _validate_type_ccomponentlistTool(self,value):
        if isinstance(value,casatools.componentlist):
            return True
