...
class calibrater(_object):
    ...
    def setsolve(self, *args, **kwargs) -> "bool":
        """
        setsolve(self, _type, _t, _table, _append, _preavg, _phaseonly, _apmode, _refant, _refantmode, _minblperant, _solnorm, _normtype, _minsnr, _combine, _fillgaps, _cfcache, _painc, _fitorder, _fraction, _numedge, _radius, _smooth, _zerorates, _globalsolve, _niter, _delaywindow, _ratewindow, _paramactive, _solmode, _rmsthresh) -> bool
