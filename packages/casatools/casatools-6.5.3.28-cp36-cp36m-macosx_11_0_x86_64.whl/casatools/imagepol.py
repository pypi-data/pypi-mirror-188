...
class imagepol:
    ...
    def imagepoltestimage(self, outfile='imagepol.iquv', rm=[ float(0.0) ], pa0=float(0.0), sigma=float(0.01), nx=int(32), ny=int(32), nf=int(32), f0=float(1.4e9), bw=float(128.0e6)):
        ...
        """
        return self._swigobj.imagepoltestimage(outfile, rm, pa0, sigma, nx, ny, nf, f0, bw)
    ...
    def complexlinpol(self, outfile):
        ...
        """
        return self._swigobj.complexlinpol(outfile)
    ...
    def complexfraclinpol(self, outfile):
        ...
        Table tool can access Complex images.
        """
        return self._swigobj.complexfraclinpol(outfile)
    ...
    def depolratio(self, infile, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        sigmadepolratio.
        """
        return _wrap_image(swig_object=self._swigobj.depolratio(infile, debias, clip, sigma, outfile))
    ...
    def fourierrotationmeasure(self, complex='', amp='', pa='', real='', imag='', zerolag0=False):
        ...
        """
        return self._swigobj.fourierrotationmeasure(complex, amp, pa, real, imag, zerolag0)
    ...
    def fraclinpol(self, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.fraclinpol(debias, clip, sigma, outfile))
    ...
    def fractotpol(self, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.fractotpol(debias, clip, sigma, outfile))
    ...
    def linpolint(self, debias=False, clip=float(10.0), sigma=float(-1), outfile='', region='', mask='', stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.linpolint(debias, clip, sigma, outfile, region, mask, stretch))
    ...
    def linpolposang(self, outfile='', region='', mask='', stretch=False):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.linpolposang(outfile, region, mask, stretch))
    ...
    def makecomplex(self, complex, real='', imag='', amp='', phase=''):
        ...
        parts are formed.
        """
        return self._swigobj.makecomplex(complex, real, imag, amp, phase)
    ...
    def open(self, image={ }):
        ...
        """
        return self._swigobj.open(image)
    ...
    def pol(self, which, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.pol(which, debias, clip, sigma, outfile))
    ...
    def rotationmeasure(self, rm='', rmerr='', pa0='', pa0err='', nturns='', chisq='', sigma=float(-1), rmfg=float(0.0), rmmax=float(0.0), maxpaerr=float(1e30), plotter='', nx=int(5), ny=int(5)):
        ...
        """
        return self._swigobj.rotationmeasure(rm, rmerr, pa0, pa0err, nturns, chisq, sigma, rmfg, rmmax, maxpaerr, plotter, nx, ny)
    ...
    def sigmadepolratio(self, infile, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        depolratio.
        """
        return _wrap_image(swig_object=self._swigobj.sigmadepolratio(infile, debias, clip, sigma, outfile))
    ...
    def sigmafraclinpol(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        """
        return _wrap_image(swig_object=self._swigobj.sigmafraclinpol(clip, sigma, outfile))
    ...
    def sigmafractotpol(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return _wrap_image(swig_object=self._swigobj.sigmafractotpol(clip, sigma, outfile))
    ...
    def sigmalinpolint(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return self._swigobj.sigmalinpolint(clip, sigma, outfile)
    ...
    def sigmalinpolposang(self, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        with outliers from the mean clipped at the specified level.
        """
        return _wrap_image(swig_object=self._swigobj.sigmalinpolposang(clip, sigma, outfile))
    ...
    def sigmastokes(self, which, clip=float(10.0)):
        ...
        """
        return self._swigobj.sigmastokes(which, clip)
    ...
    def totpolint(self, debias=False, clip=float(10.0), sigma=float(-1), outfile='', region='', mask='', stretch=False):
        ...
        then sigma is computed.
        """
        return _wrap_image(swig_object=self._swigobj.totpolint(debias, clip, sigma, outfile, region, mask, stretch))
