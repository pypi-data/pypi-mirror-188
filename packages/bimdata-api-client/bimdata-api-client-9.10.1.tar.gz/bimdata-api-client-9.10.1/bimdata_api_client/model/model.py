...
class Model(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, creator, status, created_at, updated_at, document_id, document, structure_file, systems_file, map_file, gltf_file, bvh_tree_file, preview_file, viewer_360_file, xkt_file, project_id, errors, warnings, page_number, children, *args, **kwargs):  # noqa: E501
