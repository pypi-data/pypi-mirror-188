...
@LastEditTime: 2023-01-30 14:52:02
...
class TaskBaseModel(FrameBaseModel):
        ...
        for task_info_dict in task_info_list:
            ...
            #加入会员
                ...
                if not user_info_dict:
                    ...
                    if top_base_model.check_is_member(mix_nick,user_info_dict["user_nick"],access_token,app_key,app_secret,is_log) == True:
                        result["status"] = 1
                    else:
                        result["status"] = 0
                result["content"] = ""
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    task_count_model = TaskCountModel(db_transaction=db_transaction, context=self.context)
    ...
    def process_invite_join_member(self, app_id, act_id, module_id, user_id, login_token, mix_nick, from_user_id, handler_name, access_token, app_key, app_secret, check_user_nick=True, continue_request_expire=5, close_invite_limit=False):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if top_base_model.check_is_member(mix_nick, '', access_token, app_key, app_secret) == False:
                    invoke_result_data.success = False
                    invoke_result_data.error_code = "error"
    ...
    def process_routine_invite_task(self,task_type,invite_sub_table,app_id,act_id,module_id,user_id,login_token,from_user_id,handler_name,check_user_nick=True,check_new_user=True,continue_request_expire=5,close_invite_limit=False):
        """
