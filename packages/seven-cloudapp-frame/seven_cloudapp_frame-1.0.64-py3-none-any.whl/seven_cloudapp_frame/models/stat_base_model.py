...
@LastEditTime: 2022-11-24 19:09:17
...
class StatBaseModel(FrameBaseModel):
    ...
    def get_stat_report_list(self, app_id, act_id, module_id, start_date, end_date, order_by="sort_index asc", is_only_module=False, orm_condition=None, orm_params=None):
        """
        ...
        if is_only_module == True:
            ...
            if not orm_params:
                orm_params = [act_id,module_id]
        stat_orm_list = StatOrmModel(context=self.context).get_list(where=orm_condition, order_by=order_by, params=orm_params)
        ...
        behavior_report_list = stat_report_model.get_dict_list(report_condition, group_by="key_name", field="key_name,SUM(key_value) AS key_value",params=params)
        #公共映射组（未去重）
    ...
    def get_trend_report_list(self, app_id, act_id, module_id, start_date, end_date, order_by="sort_index asc", is_only_module=False, orm_condition=None, orm_params=None):
        """
