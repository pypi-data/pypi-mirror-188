...
@LastEditTime: 2023-01-17 19:00:32
...
class ActInfoListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        act_base_model = ActBaseModel(context=self)
        page_list, total = act_base_model.get_act_info_list(app_id, act_name, is_del, page_size, page_index, False, act_type, is_release)
