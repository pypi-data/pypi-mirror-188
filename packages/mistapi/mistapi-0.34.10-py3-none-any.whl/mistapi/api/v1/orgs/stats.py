...
def searchOrgAssets(mist_session:_APISession, org_id:str, site_id:str=None, mac:str=None, map_id:str=None, ibeacon_uuid:str=None, ibeacon_major:str=None, ibeacon_minor:str=None, ap_mac:str=None, beam:str=None, rssi:str=None, page:int=1, limit:int=100, start:int=None, end:int=None, duration:str="1d") -> _APIResponse:
    """
