...
def searchSiteCalls(mist_session:_APISession, site_id:str, mac:str=None, app:str=None, page:int=1, limit:int=100, start:int=None, end:int=None, duration:str="1d") -> _APIResponse:
    """
...
def searchSiteDiscoveredSwitches(mist_session:_APISession, site_id:str, system_name:str=None, mgmt_addr:str=None, model:str=None, version:str=None, page:int=1, limit:int=100, start:int=None, end:int=None, duration:str="1d") -> _APIResponse:
    """
