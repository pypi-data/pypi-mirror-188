...
class TestBase(unittest.TestCase):
    ...
    def test_loadConfig(self):
        ...
        with patch("builtins.open", mock_open(read_data=fileData)) as m:
            ...
            b.importConfigsByImportValue.assert_has_calls(
                [call("importBefore", {"foo": "bar"}, "test.config"), call("importAfter", {"foo": "bar"}, "test.config")]
            )
    ...
    def test_validateConfigDontOverwrite(self):
        ...
        self.assertEqual(config, {"name": "p", "namespace": "n", "phases": [], "exporter": ["myExporter"]})
    ...
    def test_normalizeDataArray(self):
        ...
        self.assertEqual(normalized, {"name": "test", "config": {"foo": "bar", "items": [{"name": "foo", "value": "bar"}]}})
