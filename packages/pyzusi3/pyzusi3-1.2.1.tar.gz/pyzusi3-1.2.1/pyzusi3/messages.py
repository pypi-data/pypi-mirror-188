...
llps[STATUS_ETCS_EINSTELLUNGEN_STMSYSTEM] = llps[STATUS_ETCS_EINSTELLUNGEN]
...
INPUT = namedtuple("INPUT", [
    ...
    'etcs_zustand', 'etcs_brh', 'etcs_zugkategorie', 'etcs_zuglaenge', 'etcs_vmax_kmh', 'etcs_achslast_kg', 'etcs_zugnummer', 'etcs_tfnummer', 'etcs_rbc_nummer', 'etcs_rbc_telefon', 'etcs_rbc_id', 'etcs_rbc_land', 'etcs_gsmr_netz_id', 'etcs_gsmr_status', 'etcs_reibwert', 'etcs_passivschalter', 'etcs_stoerschalter', 'etcs_luftabsperrhahn', 'etcs_quittierschalter', 'etcs_override_anforderung', 'etcs_start', 'etcs_level_einstellen', 'etcs_stmindex_einstellen', 'etcs_modus_einstellen', 'etcs_taf_modus', 'etcs_zugneustart', 'etcs_infoton_fordern', 'etcs_funktionspruefung', 'etcs_evc_baseline', 'etcs_lss_vorhanden', 'etcs_passivschalter_vorhanden', 'etcs_resetschalter_vorhanden', 'etcs_resetsoftkey_vorhanden', 'etcs_lss_status', 'etcs_reset',
    'zbs_brh', 'zbs_zl', 'zbs_vmz', 'zbs_zugnummer', 'zbs_tfnummer', 'zbs_stoerschalter', 'zbs_hauptschalter', 'zbs_luftabsperrhahn', 'zbs_betriebszustand_anfordern', 'zbs_gewaehltes_altsystem', 'zbs_zugneustart', 'zbs_systemstatus',
...
llps[INPUT] = (
    ...
    # ETCS
    LLP(PID(2, 0x010a, 2, 4), None, BasicNode),
    LLP(PID(2, 0x010a, 2, 4, 1), 'etcs_zustand', ContentType.BYTE, ETCS_ZUGDATEN),
    LLP(PID(2, 0x010a, 2, 4, 3, 1), 'etcs_brh', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 4, 3, 2), 'etcs_zugkategorie', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 4, 3, 3), 'etcs_zuglaenge', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 4, 3, 4), 'etcs_vmax_kmh', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 4, 3, 5), 'etcs_achslast_kg', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 4, 3, 6), 'etcs_zugnummer', ContentType.STRING),
    LLP(PID(2, 0x010a, 2, 4, 3, 7), 'etcs_tfnummer', ContentType.STRING),
    LLP(PID(2, 0x010a, 2, 4, 3, 8), 'etcs_rbc_nummer', ContentType.CARDINAL),
    LLP(PID(2, 0x010a, 2, 4, 3, 9), 'etcs_rbc_telefon', ContentType.STRING),
    LLP(PID(2, 0x010a, 2, 4, 3, 0x0a), 'etcs_rbc_id', ContentType.CARDINAL),
    LLP(PID(2, 0x010a, 2, 4, 3, 0x0b), 'etcs_rbc_land', ContentType.CARDINAL),
    LLP(PID(2, 0x010a, 2, 4, 3, 0x0c), 'etcs_gsmr_netz_id', ContentType.CARDINAL),
    LLP(PID(2, 0x010a, 2, 4, 3, 0x0d), 'etcs_gsmr_status', ContentType.BYTE, ETCS_GSMR_MODUS),
    LLP(PID(2, 0x010a, 2, 4, 4), None, BasicNode),
    LLP(PID(2, 0x010a, 2, 4, 4, 1), 'etcs_reibwert', ContentType.BYTE, ETCS_REIBWERT),
    LLP(PID(2, 0x010a, 2, 4, 5), 'etcs_passivschalter', ContentType.BYTE, SCHALTER),
    LLP(PID(2, 0x010a, 2, 4, 6), 'etcs_stoerschalter', ContentType.BYTE, SCHALTER),
    LLP(PID(2, 0x010a, 2, 4, 7), 'etcs_luftabsperrhahn', ContentType.BYTE, ABSPERRHAHN),
    LLP(PID(2, 0x010a, 2, 4, 8), 'etcs_quittierschalter', ContentType.BYTE, ETCS_QUITTIERSCHALTER),
    LLP(PID(2, 0x010a, 2, 4, 9), 'etcs_override_anforderung', ContentType.BYTE, ETCS_OVERRIDE),
    LLP(PID(2, 0x010a, 2, 4, 0x0a), 'etcs_start', ContentType.BYTE, ETCS_START),
    LLP(PID(2, 0x010a, 2, 4, 0x0b), 'etcs_level_einstellen', ContentType.WORD, ETCS_LEVEL),
    LLP(PID(2, 0x010a, 2, 4, 0x0c), 'etcs_stmindex_einstellen', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 4, 0x0d), 'etcs_modus_einstellen', ContentType.WORD, ETCS_MODUS),
    LLP(PID(2, 0x010a, 2, 4, 0x0e), 'etcs_taf_modus', ContentType.BYTE, ETCS_TAF_MODUS),
    LLP(PID(2, 0x010a, 2, 4, 0x0f), 'etcs_zugneustart', ContentType.BYTE),
    LLP(PID(2, 0x010a, 2, 4, 0x10), 'etcs_infoton_fordern', ContentType.BYTE),
    LLP(PID(2, 0x010a, 2, 4, 0x11), 'etcs_funktionspruefung', ContentType.BYTE, ETCS_FUNKTIONSPRUEFUNG),    
    LLP(PID(2, 0x010a, 2, 4, 0x12), 'etcs_evc_baseline', ContentType.STRING),
    LLP(PID(2, 0x010a, 2, 4, 0x13), 'etcs_lss_vorhanden', ContentType.BYTE, JA_NEIN),
    LLP(PID(2, 0x010a, 2, 4, 0x14), 'etcs_passivschalter_vorhanden', ContentType.BYTE, JA_NEIN),
    LLP(PID(2, 0x010a, 2, 4, 0x15), 'etcs_resetschalter_vorhanden', ContentType.BYTE, JA_NEIN),
    LLP(PID(2, 0x010a, 2, 4, 0x16), 'etcs_resetsoftkey_vorhanden', ContentType.BYTE, JA_NEIN),
    LLP(PID(2, 0x010a, 2, 4, 0x17), 'etcs_lss_status', ContentType.BYTE, SCHALTER),
    LLP(PID(2, 0x010a, 2, 4, 0x18), 'etcs_reset', ContentType.BYTE, ETCS_START),
    # ZBS
    LLP(PID(2, 0x010a, 2, 8, 2), None, BasicNode),
    LLP(PID(2, 0x010a, 2, 8, 2, 1), 'zbs_brh', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 8, 2, 2), 'zbs_zl', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 8, 2, 3), 'zbs_vmz', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 8, 2, 4), 'zbs_zugnummer', ContentType.STRING),
    LLP(PID(2, 0x010a, 2, 8, 2, 5), 'zbs_tfnummer', ContentType.STRING),
    LLP(PID(2, 0x010a, 2, 8, 3), 'zbs_stoerschalter', ContentType.BYTE, SCHALTER),
    LLP(PID(2, 0x010a, 2, 8, 4), 'zbs_hauptschalter', ContentType.BYTE, SCHALTER),
    LLP(PID(2, 0x010a, 2, 8, 5), 'zbs_luftabsperrhahn', ContentType.BYTE, ABSPERRHAHN),
    LLP(PID(2, 0x010a, 2, 8, 6), 'zbs_betriebszustand_anfordern', ContentType.WORD, ZBS_BETRIEBSZUSTAND),
    LLP(PID(2, 0x010a, 2, 8, 7), 'zbs_gewaehltes_altsystem', ContentType.WORD),
    LLP(PID(2, 0x010a, 2, 8, 8), 'zbs_zugneustart', ContentType.BYTE),
    LLP(PID(2, 0x010a, 2, 8, 9), 'zbs_systemstatus', ContentType.BYTE, SYSTEMSTATUS),
    # Fahrsperre
