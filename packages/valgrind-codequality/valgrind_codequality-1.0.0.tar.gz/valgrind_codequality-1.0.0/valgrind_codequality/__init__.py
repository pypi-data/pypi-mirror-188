...
This tool converts the XML report generated by valgrind into a JSON file, as
defined by Code Climate.

Example:
    valgrind --xml --enable=warning,style,performance ./src 2> valgrind.xml
    python3 -m valgrind-codequality -f valgrind.xml -o valgrind.json
