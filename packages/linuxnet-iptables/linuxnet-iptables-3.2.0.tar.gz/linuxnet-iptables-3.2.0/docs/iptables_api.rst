...
* :class:`ChainRule` : objects of this class contain a
  a list of :class:`Match` objects and a :class:`Target` object
* :ref:`Match <match>` : subclasses of :class:`Match` match against specific
  attributes of a packet
* :ref:`Target <target>`: subclasses of :class:`Target` provide access to the
