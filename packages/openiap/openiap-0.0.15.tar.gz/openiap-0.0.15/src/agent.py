...
def getscriptpath(packagepath):
    if os.path.isfile( os.path.join(packagepath, "agent.py")): return os.path.join(packagepath, "agent.py")
    if os.path.isfile( os.path.join(packagepath, "main.py")): return os.path.join(packagepath, "main.py")
    if os.path.isfile( os.path.join(packagepath, "index.py")): return os.path.join(packagepath, "index.py")
    return ""
def gitclone(url):
    directory = "package"
...
if __name__ == '__main__':
    ...
    print(runit(command).decode('utf-8'))
