...
from azureml.automl.dnn.nlp.common.constants import (
    DataLiterals, ModelNames, OutputLiterals, TaskNames, ScoringLiterals, TrainingInputLiterals
)
...
def run(
    ...
    try:
        ...
        distributed = hasattr(automl_settings_obj, "enable_distributed_dnn_training") and \
            ((automl_settings_obj.enable_distributed_dnn_training is True) or
             (automl_settings_obj.enable_distributed_dnn_training == 'True')) and has_horovod
        ...
        distributed_ort_ds = hasattr(automl_settings_obj, "enable_distributed_dnn_training_ort_ds") and \
            ((automl_settings_obj.enable_distributed_dnn_training_ort_ds is True) or
             (automl_settings_obj.enable_distributed_dnn_training_ort_ds == 'True'))
        if distributed:
        ...
        if is_main_process():
            ...
            # Save for inference
            inf_env = current_run.get_environment()
            ...
            conda_file_path = save_conda_yml(inf_env)
