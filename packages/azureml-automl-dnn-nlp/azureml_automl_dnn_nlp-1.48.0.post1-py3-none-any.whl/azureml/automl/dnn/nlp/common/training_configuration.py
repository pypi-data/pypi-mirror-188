...
class TrainingConfiguration:
    ...
    def populate_from_scope(task_type: str,
        ...
        if (TrainingInputLiterals.TRAIN_BATCH_SIZE in user_settings or
                TrainingInputLiterals.GRADIENT_ACCUMULATION_STEPS in user_settings or
                model_name in [ModelNames.DISTILBERT_BASE_CASED, ModelNames.DISTILROBERTA_BASE]):
