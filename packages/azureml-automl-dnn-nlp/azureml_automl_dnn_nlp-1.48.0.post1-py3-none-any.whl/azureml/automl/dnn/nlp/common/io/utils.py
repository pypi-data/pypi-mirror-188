...
from azureml.automl.core.shared.constants import MLFlowLiterals, RUN_ID_OUTPUT_PATH, INFERENCE_DEPENDENCIES
...
def save_model_wrapper(run: Run,
    ...
    if has_optimum:
        ...
        acpt_inference_deps = CondaDependencies.create(conda_packages=inference.AutoMLNLPCondaPackagesList,
                                                       python_version=python_version,
                                                       pip_packages=inference.AutoMLNLPPipPackagesList,
                                                       pin_sdk_version=False)
        strs_to_save[INFERENCE_DEPENDENCIES] = acpt_inference_deps
