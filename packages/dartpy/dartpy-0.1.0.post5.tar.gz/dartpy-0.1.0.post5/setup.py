        ...
        if self.compiler.compiler_type != "msvc":
            ...
            if not cmake_generator or cmake_generator == "Ninja":
                try:
                    ...
                    print("[DEBUG] using Ninja generator")
                except ImportError:
                    pass
            ...
            # Increase the amount of memory allocated to MSVC to prevent error
...
#             if sys.maxsize > 2**32:
#                 cmake_args += ['-A', 'x64']
#             cmake_args += ['-DDART_IN_CI=ON']  # TODO: Remove this
#             # build_args += ['--', '/m']      # Disable parallel build, for dartpy build with ciwheelbuild
#         else:
