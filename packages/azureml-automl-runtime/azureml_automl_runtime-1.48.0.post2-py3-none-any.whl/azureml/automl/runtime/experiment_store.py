...
class ExperimentData(_CacheableStoreBase):
    ...
    class PartitionData(_CacheableStoreBase):
        ...
        def save_prepared_test_dataset(self, workspace, path_to_dataset, partition_keys):
            self._prepared_test_dataset_id = self._save_dataset(workspace, path_to_dataset, partition_keys)
