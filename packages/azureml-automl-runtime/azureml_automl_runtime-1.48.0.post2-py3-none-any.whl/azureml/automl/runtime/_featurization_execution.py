...
def _featurize_training_data(
    ...
    # Perform class balancing check for Classification task only if the user has not already
    # provided the sample weights explicitly
    if transformed_data_context.task_type == constants.Tasks.CLASSIFICATION and\
       transformed_data_context.sample_weight is None:
