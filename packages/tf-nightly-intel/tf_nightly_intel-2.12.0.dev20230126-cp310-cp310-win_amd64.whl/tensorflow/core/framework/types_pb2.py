...
_DATATYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DT_FLOAT8_E5M2_REF', index=49, number=124,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DT_FLOAT8_E4M3FN_REF', index=50, number=125,
      serialized_options=None,
      type=None),
  ],
