...
class FingerprintDef :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 saved_model_checksum() const;
  void set_saved_model_checksum(::PROTOBUF_NAMESPACE_ID::uint64 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 saved_model_checksum_;
...
inline void FingerprintDef::clear_saved_model_checksum() {
  saved_model_checksum_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 FingerprintDef::saved_model_checksum() const {
  // @@protoc_insertion_point(field_get:tensorflow.FingerprintDef.saved_model_checksum)
  return saved_model_checksum_;
}
inline void FingerprintDef::set_saved_model_checksum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  saved_model_checksum_ = value;
