...
ProfilerServiceMonitorResult = _reflection.GeneratedProtocolMessageType('ProfilerServiceMonitorResult', (_message.Message,), {
  ...
  '__module__' : 'tensorflow.tsl.profiler.protobuf.profiler_service_monitor_result_pb2'
