...
class CompressedComponentMetadata :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_tensorflow_2fcore_2fframework_2fdataset_2eproto);
    return ::descriptor_table_tensorflow_2fcore_2fframework_2fdataset_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 uncompressed_bytes(int index) const;
  void set_uncompressed_bytes(int index, ::PROTOBUF_NAMESPACE_ID::uint64 value);
  void add_uncompressed_bytes(::PROTOBUF_NAMESPACE_ID::uint64 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 > uncompressed_bytes_;
...
inline int CompressedComponentMetadata::uncompressed_bytes_size() const {
  return uncompressed_bytes_.size();
}
inline void CompressedComponentMetadata::clear_uncompressed_bytes() {
  uncompressed_bytes_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 CompressedComponentMetadata::uncompressed_bytes(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.data.CompressedComponentMetadata.uncompressed_bytes)
  return uncompressed_bytes_.Get(index);
}
inline void CompressedComponentMetadata::set_uncompressed_bytes(int index, ::PROTOBUF_NAMESPACE_ID::uint64 value) {
  uncompressed_bytes_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorflow.data.CompressedComponentMetadata.uncompressed_bytes)
}
inline void CompressedComponentMetadata::add_uncompressed_bytes(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  uncompressed_bytes_.Add(value);
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CompressedElement::version() const {
  // @@protoc_insertion_point(field_get:tensorflow.data.CompressedElement.version)
  return version_;
}
inline void CompressedElement::set_version(::PROTOBUF_NAMESPACE_ID::int32 value) {
