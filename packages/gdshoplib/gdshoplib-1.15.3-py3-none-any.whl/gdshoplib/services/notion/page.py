...
class PageProperty:
    ...
    def properties_keys_map(self):
        return {
            ...
            "custom_price": (dict(name="Своя цена", id="%3Cu%7DF"),),
            "order_type": (dict(name="Тип заказа", id="%40%5Eql"),),
            "status": (dict(name="Status", id="EGwa"),),
            "delivery_url": (dict(name="Доставка", id="H%60%3Bx"),),
            "promocodes": (dict(name="🎫 Промокоды", id="L%5CU%60"),),
            "pay_url": (dict(name="Оплата", id="%5D%7BRo"),),
            "price_result": (dict(name="Итого", id="bAsK"),),
            "products": (dict(name="🥇 Товары", id="e%3BIp"),),
            "customer": (dict(name="Клиент", id="hGXc"),),
            "delivery_address": (dict(name="Адрес доставки", id="kIpj"),),
            "discount": (dict(name="Скидка", id="k%5EOl"),),
            "platform": (dict(name="Откуда", id="n_pE"),),
            "bill_url": (dict(name="Чек", id="xb%3C%3D"),),
            "pay_type": (dict(name="Тип оплаты", id="yq%3Dw"),),
            "nps": (dict(name="NPS", id="%7Biv%7B"),),
            "order_id": (dict(name="ID заказа", id="%7CQ%5Dy"),),
            "transcription": (dict(name="Расчеты", id="~g~T"),),
            "profit": (dict(name="Прибыль", id="MaSy"),),
        }
