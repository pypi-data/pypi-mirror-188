...
class UpdateModelVersionRequest:
    ...
    @name.setter
    def name(self, value: str) -> None:
        _set_attribute(self._attributes, "UpdateModelVersionRequest", "name", value, str, "")
...
class GenerateArtifactUploadURLRequest:
    ...
    @run.setter
    def run(self, value: str) -> None:
        _set_attribute(self._attributes, "GenerateArtifactUploadURLRequest", "run", value, str, "")
...
class UpdateDatasetVersionRequest:
    ...
    @name.setter
    def name(self, value: str) -> None:
        _set_attribute(self._attributes, "UpdateDatasetVersionRequest", "name", value, str, "")
