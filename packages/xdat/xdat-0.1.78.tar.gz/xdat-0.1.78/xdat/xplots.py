...
def post_plot(title='', legend=True, legend_loc='best', xlim=None, ylim=None, xlabel=None, ylabel=None, tight_layout=True, show=True, y_auc=False):
    """
    ...
    for df_p, _, plot_title in xpd.x_iter_groups(df, plot_on):
        ...
        for df_g, _, group_title in xpd.x_iter_groups(df_p, group_on):
            ...
            if kind in ['scatter', 'reg']:
                ...
                df_means = g_hdi.mean()[y].reset_index(name='_mean_val')
