...
def vipermirrorbrokers(vipertoken,host,port,brokercloudusernamepassfrom,brokercloudusernamepassto,enabletlsfrom,enabletlsto,
                                          ...
                                          topiclist,asynctimeout=300,microserviceid="",servicenamefrom="broker",servicenameto="broker",rollbackoffset=0):
    global connectionerror


    if (len(host)==0 or len(vipertoken)==0 or len(brokercloudusernamepassfrom)==0 or len(brokercloudusernamepassto)==0
         or len(enabletlsfrom)==0 or len(enabletlsto)==0 or len(replicationfactorfrom)==0 or len(replicationfactorto)==0
...
enabletlsto,replicationfactorfrom,replicationfactorto,compressionfrom,compressionto,saslfrom,saslto,brokerlistfrom,brokerlistto")
    ...
    value=("writestreamtobrokers?vipertoken="+vipertoken + "&enabletlsfrom="+enabletlsfrom + "&enabletlsto=" + enabletlsto
           ...
           + "&rollbackoffset=" + str(rollbackoffset))
