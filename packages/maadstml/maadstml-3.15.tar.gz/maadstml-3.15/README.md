...
- **vipermirrorbrokers**
  - Migrate data streams from (mutiple) brokers to (multiple) brokers FAST!  In one simple function you have the 
	...
	with ease.  Viper ensures no duplication of messages.  Every transaction is logged, making data validation
    and auditability a snap.
...
**35. maadstml.vipermirrorbrokers(VIPERTOKEN,host,port,brokercloudusernamepassfrom,brokercloudusernamepassto,enabletlsfrom,enabletlsto,
										  ...
										  servicenameto="broker",rollbackoffset=0)**
...
- This is a comma separated list of whether source brokers require TLS: 1=TLS, 0=NoTLS. For multiple brokers separate with comma, 
  for example for 3 brokers: 1,0,1.  Some brokers may be On-Prem and do not need TLS.
  
*enabletlsto* : string, required

- This is a comma separated list of whether destination brokers require TLS: 1=TLS, 0=NoTLS. For multiple brokers separate with comma, 
  for example for 3 brokers: 1,0,1.  Some brokers may be On-Prem and do not need TLS.

*replicationfactorfrom* : string, required

- This is a comma separated list of the replication factor of source brokers. For multiple brokers separate with comma, 
  for example for 3 brokers: 3,4,3.  
  
*replicationfactorto* : string, required

- This is a comma separated list of the replication factor of destination brokers. For multiple brokers separate with comma, 
  for example for 3 brokers: 3,4,3.  

*compressionfrom* : string, required

- This is a comma separated list of the compression type of source brokers: snappy, gzip, lz4. For multiple brokers separate with comma, 
  for example for 3 brokers: snappy,snappy,gzip.  
  
*compressionto* : string, required

- This is a comma separated list of the compression type of destination brokers: snappy, gzip, lz4. For multiple brokers separate with comma, 
  for example for 3 brokers: snappy,snappy,gzip.  

*saslfrom* : string, required

- This is a comma separated list of the SASL type: None, Plain, SCRAM256, SCRAM512 of source brokers. For multiple brokers separate with comma, 
  for example for 3 brokers: Plain,SCRAM256,SCRAM512.  
  
*saslto* : string, required

- This is a comma separated list of the SASL type: None, Plain, SCRAM256, SCRAM512 of destination brokers. For multiple brokers separate with comma, 
  for example for 3 brokers: Plain,SCRAM256,SCRAM512.  
