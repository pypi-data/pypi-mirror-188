...
from package_client.client.client.main_window_conv import Ui_MainClientWindow
from package_client.client.client.add_contact import AddContactDialog
from package_client.client.client.del_contact import DelContactDialog
...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # объект - дешифровщик сообщений с загруженным ключом
    ...
    def select_active_user(self):
        ...
        # Выбранный пользователем (двойной клик) находится в выделенном элементе в
        # QListView
