...
class MobileContractProcess(BaseContractProcess):
    ...
    def _create_mobile_contract_service_info(self, params):
        ...
        return (
            ...
            .sudo()
            .create({"phone_number": params["phone_number"], "icc": params["icc"]})
        )

    def _is_pack(self, contract_lines):
        product_codes = [line["product_code"] for line in contract_lines]
    ...
    def create(self, **params):
        contract_dict = super(MobileContractProcess, self).create(**params)
        if self._is_pack(params["contract_lines"]):
    ...
    def _relate_with_parent_pack_contract(self, contract_dict, parent_pack_contract_id):
