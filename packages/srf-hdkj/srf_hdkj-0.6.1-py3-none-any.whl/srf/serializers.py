...
from srf.fields import (
    empty, SkipField, Field, TimeField, DateTimeField, SerializerMethodField,
    CharField, ChoiceField, DateField, DecimalField, FloatField,
    IntegerField,
)
    ...
    def get_effective_field(self, model_fields) -> dict:
        ...
        if meta_exclude is not None:
            ...
            for k, v in model_fields.items():
                if k in meta_fields:
                    res_fields[k] = v
                elif isinstance(v, tortoise_fields.UUIDField):
                    if k.rsplit("_", 1)[0] in meta_fields:
                        res_fields[k.rsplit("_", 1)[0]] = v
