...
class APIClient:
    ...
    def __init__(self, wml_credentials, project_id=None, verify=None):
        ...
        if 'token' not in wml_credentials and 'password' not in wml_credentials and 'apikey' not in wml_credentials:
            try:
        ...
        if 'instance_id' not in wml_credentials.keys():
            ...
            if 'icp' == wml_credentials[u'instance_id'].lower() or 'openshift' == wml_credentials[
                ...
                if 'version' in wml_credentials.keys() and (wml_credentials[u'version'].lower() in ['3.5', '4.0', '4.5', '4.6', '1.1', '2.0']):
                    self.CAMS = True
                    ...
                    if wml_credentials[u'version'].lower() in ['4.0', '4.5', '4.6']:
                        self.ICP_PLATFORM_SPACES = True
                        self.ICP_40 = wml_credentials[u'version'].lower() == '4.0'
                        self.ICP_45 = wml_credentials[u'version'].lower() == '4.5'
                        self.ICP_46 = wml_credentials[u'version'].lower() == '4.6'
