...
class DataFrame():
    ...
    def __init__(self, arg0: handle) -> None: ...
...
class DocsKVStream():
    ...
    pass
class EdgesRange():
    def __call__(self, arg0: bool) -> EdgesRange: ...
    def __iter__(self) -> edges_stream_t: ...
    pass
class EdgesStream():
...
class Network():
    ...
    def __getitem__(self, n: int) -> object: 
        ...
        """
    def __init__(self, db: DataBase, index: typing.Optional[str], vertices: typing.Optional[str] = None, relations: typing.Optional[str] = None, directed: bool = False, multi: bool = False, loops: bool = False) -> None: ...
    ...
    pass
class NodesRange():
    def __call__(self, arg0: bool) -> NodesRange: ...
