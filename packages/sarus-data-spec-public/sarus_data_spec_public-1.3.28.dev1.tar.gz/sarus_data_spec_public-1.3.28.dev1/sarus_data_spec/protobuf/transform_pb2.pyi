...
class Transform(google.protobuf.message.Message):
    ...
    class Spec(google.protobuf.message.Message):
        ...
        @property
        def slice(self) -> global___Transform.Slice: ...
        @property
        ...
        def __init__(self,
            *,
            ...
            slice : typing.Optional[global___Transform.Slice] = ...,
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"cast",b"cast",u"composed",b"composed",u"differentiated_sample",b"differentiated_sample",u"external",b"external",u"extract",b"extract",u"filter",b"filter",u"get_item",b"get_item",u"identity",b"identity",u"inverse_transcode",b"inverse_transcode",u"join",b"join",u"project",b"project",u"protect_dataset",b"protect_dataset",u"sample",b"sample",u"select_sql",b"select_sql",u"shuffle",b"shuffle",u"slice",b"slice",u"spec",b"spec",u"synthetic",b"synthetic",u"transcode",b"transcode",u"user_settings",b"user_settings",u"variable",b"variable"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"cast",b"cast",u"composed",b"composed",u"differentiated_sample",b"differentiated_sample",u"external",b"external",u"extract",b"extract",u"filter",b"filter",u"get_item",b"get_item",u"identity",b"identity",u"inverse_transcode",b"inverse_transcode",u"join",b"join",u"project",b"project",u"protect_dataset",b"protect_dataset",u"sample",b"sample",u"select_sql",b"select_sql",u"shuffle",b"shuffle",u"slice",b"slice",u"spec",b"spec",u"synthetic",b"synthetic",u"transcode",b"transcode",u"user_settings",b"user_settings",u"variable",b"variable"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"spec",b"spec"]) -> typing.Optional[typing_extensions.Literal["identity","variable","composed","project","filter","shuffle","join","cast","sample","user_settings","protect_dataset","external","synthetic","transcode","inverse_transcode","get_item","select_sql","slice","extract","differentiated_sample"]]: ...
    ...
    class SelectSql(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"query",b"query"]) -> None: ...
    ...
    class Extract(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"seed",b"seed",u"size",b"size"]) -> None: ...
