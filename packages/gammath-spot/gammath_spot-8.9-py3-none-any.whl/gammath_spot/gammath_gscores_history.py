...
class GSH:
    ...
    def get_gscores_history(self, tsymbol):
        ...
        try:
            ...
            if (gscores_history_exists):
                ...
                if (df_last_date == gscores_last_date):
                    ...
                    if (missing_gscores_count != -1):
                        ...
                        initial_start_index = (initial_end_index - mtd5y)
                        #Clip missing_gscores_count-gscores from start to make room for missing gscores near the end
                        df_gscores = df_gscores.truncate(before=missing_gscores_count).reset_index().drop(columns='index')
                    else:
            ...
            #Get the start index for gscores
            gscores_start_index = (mtd5y - missing_gscores_count)
