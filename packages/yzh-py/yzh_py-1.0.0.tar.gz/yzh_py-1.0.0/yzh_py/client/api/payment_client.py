...
class PaymentClient(BaseClient):
    ...
    def create_wxpay_order(self, request: CreateWxpayOrderRequest):
        ...
        """
        return self._post("/api/payment/v1/order-wxpay", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def get_dealer_v_a_recharge_account(self, request: GetDealerVARechargeAccountRequest):
        ...
        """
        return self._get("/api/payment/v1/va-account", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def list_account(self, request: ListAccountRequest):
        ...
        """
        return self._get("/api/payment/v1/query-accounts", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def get_ele_receipt_file(self, request: GetEleReceiptFileRequest):
        ...
        """
        return self._get("/api/payment/v1/receipt/file", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def cancel_order(self, request: CancelOrderRequest):
        ...
        """
        return self._post("/api/payment/v1/order/fail", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def create_batch_order(self, request: CreateBatchOrderRequest):
        ...
        """
        return self._post("/api/payment/v1/order-batch", request.request_id, Utils.copy_dict(request.__dict__))
    ...
    def confirm_batch_order(self, request: ConfirmBatchOrderRequest):
        ...
        """
        return self._post("/api/payment/v1/confirm-batch", request.request_id, Utils.copy_dict(request.__dict__))
