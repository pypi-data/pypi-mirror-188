...
class AlertManagerConfigurationDetails:
    def __init__(self, *, contents: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfigurationDetails.__init__)
...
class AlertManagerConfigurationProps:
    def __init__(
        ...
        *,
        ...
        default_route: typing.Optional[typing.Union["DefaultRouteOptions", typing.Dict[str, typing.Any]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfigurationProps.__init__)
...
class AlertManagerDestination(
    ...
    def sns_topic(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerDestination.sns_topic)
...
class AlertManagerDestinationCategory(
    ...
    def of(cls, name: builtins.str) -> "AlertManagerDestinationCategory":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerDestinationCategory.of)
...
class AlertManagerInhibitRule(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerInhibitRule.__init__)
    ...
    def add_equal_label(self, label: builtins.str) -> "AlertManagerInhibitRule":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerInhibitRule.add_equal_label)
    ...
    def add_source_matcher(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerInhibitRule.add_source_matcher)
    ...
    def add_target_matcher(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerInhibitRule.add_target_matcher)
            check_type(argname="argument matcher", value=matcher, expected_type=type_hints["matcher"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerInhibitRule.bind)
...
class AlertManagerMatcher(
    ...
    def from_components(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerMatcher.from_components)
            check_type(argname="argument label", value=label, expected_type=type_hints["label"])
    ...
    def from_compound(cls, *matchers: "AlertManagerMatcher") -> "AlertManagerMatcher":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerMatcher.from_compound)
    ...
    def from_string(cls, expression: builtins.str) -> "AlertManagerMatcher":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerMatcher.from_string)
...
class AlertManagerReceiver(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerReceiver.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_destination(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerReceiver.add_destination)
    ...
    def add_sns_topic(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerReceiver.add_sns_topic)
            check_type(argname="argument topic", value=topic, expected_type=type_hints["topic"])
        options = AlertManagerSnsDestinationOptions(
            api_url=api_url,
            attributes=attributes,
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerReceiver.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class AlertManagerReceiverProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerReceiverProps.__init__)
...
class AlertManagerRoute(
    ...
    def __init__(
        ...
        *,
        ...
        children: typing.Optional[typing.Sequence[typing.Union["AlertManagerRouteProps", typing.Dict[str, typing.Any]]]] = None,
        continue_matching: typing.Optional[builtins.bool] = None,
        group_by_labels: typing.Optional[typing.Sequence[builtins.str]] = None,
        group_interval: typing.Optional[aws_cdk.Duration] = None,
        group_wait: typing.Optional[aws_cdk.Duration] = None,
        ...
        repeat_interval: typing.Optional[aws_cdk.Duration] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_active_time_interval(self, interval: "TimeInterval") -> "AlertManagerRoute":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.add_active_time_interval)
    ...
    def add_child(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.add_child)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = AlertManagerRouteProps(
            receiver=receiver,
            active_time_intervals=active_time_intervals,
    ...
    def add_group_by_label(self, label: builtins.str) -> "AlertManagerRoute":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.add_group_by_label)
            check_type(argname="argument label", value=label, expected_type=type_hints["label"])
    ...
    def add_matcher(self, matcher: AlertManagerMatcher) -> "AlertManagerRoute":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.add_matcher)
            check_type(argname="argument matcher", value=matcher, expected_type=type_hints["matcher"])
    ...
    def add_mute_time_interval(self, interval: "TimeInterval") -> "AlertManagerRoute":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.add_mute_time_interval)
            check_type(argname="argument interval", value=interval, expected_type=type_hints["interval"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRoute.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [scope]))
    ...
    def group_interval(self) -> typing.Optional[aws_cdk.Duration]:
        ...
        :group: Inputs
        '''
        return typing.cast(typing.Optional[aws_cdk.Duration], jsii.get(self, "groupInterval"))

    @builtins.property
    @jsii.member(jsii_name="groupWait")
    def group_wait(self) -> typing.Optional[aws_cdk.Duration]:
        ...
        :group: Inputs
        '''
        return typing.cast(typing.Optional[aws_cdk.Duration], jsii.get(self, "groupWait"))

    @builtins.property
    @jsii.member(jsii_name="repeatInterval")
    def repeat_interval(self) -> typing.Optional[aws_cdk.Duration]:
        ...
        :group: Inputs
        '''
        return typing.cast(typing.Optional[aws_cdk.Duration], jsii.get(self, "repeatInterval"))
...
class AlertManagerRouteProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerRouteProps.__init__)
...
class AlertManagerSnsDestinationOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerSnsDestinationOptions.__init__)
...
class AlertManagerSnsDestinationProps(AlertManagerSnsDestinationOptions):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerSnsDestinationProps.__init__)
            check_type(argname="argument api_url", value=api_url, expected_type=type_hints["api_url"])
            check_type(argname="argument attributes", value=attributes, expected_type=type_hints["attributes"])
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
            check_type(argname="argument send_resolved", value=send_resolved, expected_type=type_hints["send_resolved"])
...
class AlertManagerTemplate(
    ...
    def from_file(cls, path: builtins.str) -> "AlertManagerTemplate":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerTemplate.from_file)
    ...
    def from_string(cls, content: builtins.str) -> "AlertManagerTemplate":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerTemplate.from_string)
...
class AlertingRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertingRuleProps.__init__)
...
class DayOfMonthRange:
    def __init__(self, *, end: jsii.Number, start: jsii.Number) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DayOfMonthRange.__init__)
...
class DefaultRouteOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DefaultRouteOptions.__init__)
            check_type(argname="argument group_by_labels", value=group_by_labels, expected_type=type_hints["group_by_labels"])
            check_type(argname="argument group_interval", value=group_interval, expected_type=type_hints["group_interval"])
            check_type(argname="argument group_wait", value=group_wait, expected_type=type_hints["group_wait"])
            check_type(argname="argument matchers", value=matchers, expected_type=type_hints["matchers"])
...
class IAlertManagerConfiguration(typing_extensions.Protocol):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, scope: constructs.IConstruct) -> AlertManagerConfigurationDetails:
...
class _IAlertManagerConfigurationProxy:
    ...
    def bind(self, scope: constructs.IConstruct) -> AlertManagerConfigurationDetails:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IAlertManagerConfiguration.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class _IAlertManagerDestinationProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IAlertManagerDestination.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [scope]))
...
class _IPrometheusRuleProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IPrometheusRule.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [scope]))
...
class IRuleGroupConfiguration(constructs.IConstruct, typing_extensions.Protocol):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, scope: constructs.IConstruct) -> "RuleGroupConfigurationDetails":
...
class _IRuleGroupConfigurationProxy(
    ...
    def bind(self, scope: constructs.IConstruct) -> "RuleGroupConfigurationDetails":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IRuleGroupConfiguration.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class MonthRange:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MonthRange.__init__)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
        self._values: typing.Dict[str, typing.Any] = {
            "start": start,
...
class RecordingRule(
    ...
    def add_label(self, label: builtins.str, value: builtins.str) -> "RecordingRule":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RecordingRule.add_label)
            check_type(argname="argument label", value=label, expected_type=type_hints["label"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RecordingRule.bind)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [_scope]))
...
class RecordingRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RecordingRuleProps.__init__)
            check_type(argname="argument expression", value=expression, expected_type=type_hints["expression"])
...
class RuleGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_rule(self, rule: IPrometheusRule) -> "RuleGroup":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroup.add_rule)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroup.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [scope]))
...
class RuleGroupConfiguration(
    ...
    def __init__(self, scope: constructs.IConstruct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupConfiguration.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_content(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupConfiguration.from_content)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument content", value=content, expected_type=type_hints["content"])
    ...
    def from_rules_file(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupConfiguration.from_rules_file)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
    ...
    def add_rule_group(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupConfiguration.add_rule_group)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def bind(self, scope: constructs.IConstruct) -> "RuleGroupConfigurationDetails":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupConfiguration.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast("RuleGroupConfigurationDetails", jsii.invoke(self, "bind", [scope]))
...
class RuleGroupConfigurationDetails:
    def __init__(self, *, content: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupConfigurationDetails.__init__)
            check_type(argname="argument content", value=content, expected_type=type_hints["content"])
        self._values: typing.Dict[str, typing.Any] = {
            "content": content,
        }
...
class RuleGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupProps.__init__)
            check_type(argname="argument interval", value=interval, expected_type=type_hints["interval"])
...
class RuleGroupsNamespace(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupsNamespace.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_rule_groups_namespace_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupsNamespace.from_rule_groups_namespace_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_rule_group(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupsNamespace.add_rule_group)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = RuleGroupProps(
            interval=interval, limit=limit, name=name, rules=rules
        )
    ...
    def resource(self) -> aws_cdk.aws_aps.CfnRuleGroupsNamespace:
        ...
        :group: Resources
        '''
        return typing.cast(aws_cdk.aws_aps.CfnRuleGroupsNamespace, jsii.get(self, "resource"))
...
class RuleGroupsNamespaceProps(aws_cdk.ResourceProps):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RuleGroupsNamespaceProps.__init__)
...
class TimeInterval(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeInterval.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_interval(self, interval: "TimeIntervalEntry") -> "TimeIntervalEntry":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeInterval.add_interval)
            check_type(argname="argument interval", value=interval, expected_type=type_hints["interval"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeInterval.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [scope]))
...
class TimeIntervalEntry(
    ...
    def __init__(
        self,
        *,
        days_of_the_month: typing.Optional[typing.Sequence[typing.Union[DayOfMonthRange, typing.Dict[str, typing.Any]]]] = None,
        months: typing.Optional[typing.Sequence[typing.Union[MonthRange, typing.Dict[str, typing.Any]]]] = None,
        times: typing.Optional[typing.Sequence[typing.Union["TimeRange", typing.Dict[str, typing.Any]]]] = None,
        time_zone: typing.Optional[builtins.str] = None,
        weekdays: typing.Optional[typing.Sequence[typing.Union["WeekdayRange", typing.Dict[str, typing.Any]]]] = None,
        years: typing.Optional[typing.Sequence[typing.Union["YearRange", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
    ...
    def add_days_of_the_month(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntry.add_days_of_the_month)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
    ...
    def add_month(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntry.add_month)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
    ...
    def add_times(self, start: builtins.str, end: builtins.str) -> "TimeIntervalEntry":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntry.add_times)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
    ...
    def add_weekday(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntry.add_weekday)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
    ...
    def add_years(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntry.add_years)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntry.bind)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [_scope]))
...
class TimeIntervalEntryProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalEntryProps.__init__)
...
class TimeIntervalProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeIntervalProps.__init__)
...
class TimeRange:
    def __init__(self, *, end: builtins.str, start: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimeRange.__init__)
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
        self._values: typing.Dict[str, typing.Any] = {
            "end": end,
...
class WeekdayRange:
    def __init__(self, *, start: Weekday, end: typing.Optional[Weekday] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WeekdayRange.__init__)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
        self._values: typing.Dict[str, typing.Any] = {
            "start": start,
...
class Workspace(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        alerting: typing.Optional[typing.Union["WorkspaceAlertingOptions", typing.Dict[str, typing.Any]]] = None,
        alias: typing.Optional[builtins.str] = None,
        logging: typing.Optional[typing.Union["WorkspaceLoggingOptions", typing.Dict[str, typing.Any]]] = None,
        account: typing.Optional[builtins.str] = None,
        environment_from_arn: typing.Optional[builtins.str] = None,
        physical_name: typing.Optional[builtins.str] = None,
        region: typing.Optional[builtins.str] = None,
    ...
    def from_workspace_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Workspace.from_workspace_arn)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_workspace_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Workspace.from_workspace_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_workspace_id(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Workspace.from_workspace_id)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    @builtins.property
    @jsii.member(jsii_name="resource")
    def resource(self) -> aws_cdk.aws_aps.CfnWorkspace:
        ...
        :group: Resources
        '''
        return typing.cast(aws_cdk.aws_aps.CfnWorkspace, jsii.get(self, "resource"))
    ...
    def alert_topic(self) -> typing.Optional[aws_cdk.aws_sns.ITopic]:
        ...
        :group: Resources
        '''
        return typing.cast(typing.Optional[aws_cdk.aws_sns.ITopic], jsii.get(self, "alertTopic"))
...
class WorkspaceAlertingOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WorkspaceAlertingOptions.__init__)
            check_type(argname="argument configuration", value=configuration, expected_type=type_hints["configuration"])
...
class WorkspaceAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WorkspaceAttributes.__init__)
            check_type(argname="argument workspace_arn", value=workspace_arn, expected_type=type_hints["workspace_arn"])
            check_type(argname="argument workspace_id", value=workspace_id, expected_type=type_hints["workspace_id"])
...
class WorkspaceLoggingOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(WorkspaceLoggingOptions.__init__)
            check_type(argname="argument enabled", value=enabled, expected_type=type_hints["enabled"])
...
class WorkspaceProps(aws_cdk.ResourceProps):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(WorkspaceProps.__init__)
            check_type(argname="argument account", value=account, expected_type=type_hints["account"])
            check_type(argname="argument environment_from_arn", value=environment_from_arn, expected_type=type_hints["environment_from_arn"])
            check_type(argname="argument physical_name", value=physical_name, expected_type=type_hints["physical_name"])
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
...
class YearRange:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(YearRange.__init__)
            check_type(argname="argument start", value=start, expected_type=type_hints["start"])
            check_type(argname="argument end", value=end, expected_type=type_hints["end"])
        self._values: typing.Dict[str, typing.Any] = {
            "start": start,
...
class AlertManagerConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_full_configuration_content(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.from_full_configuration_content)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument content", value=content, expected_type=type_hints["content"])
    ...
    def from_full_configuration_file(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.from_full_configuration_file)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
    ...
    def from_split_configuration_content(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.from_split_configuration_content)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument content", value=content, expected_type=type_hints["content"])
            check_type(argname="argument templates", value=templates, expected_type=type_hints["templates"])
    ...
    def from_split_configuration_files(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.from_split_configuration_files)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument path", value=path, expected_type=type_hints["path"])
            check_type(argname="argument templates", value=templates, expected_type=type_hints["templates"])
    ...
    def add_inhibit_rule(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.add_inhibit_rule)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument options", value=options, expected_type=type_hints["options"])
    ...
    def add_reciever(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.add_reciever)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_template(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.add_template)
    ...
    def add_time_interval(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.add_time_interval)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        options = TimeIntervalProps(intervals=intervals, name=name)
    ...
    def bind(self, scope: constructs.IConstruct) -> AlertManagerConfigurationDetails:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(AlertManagerConfigurationDetails, jsii.invoke(self, "bind", [scope]))
    ...
    def _generate_template_name(self, idx: jsii.Number) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration._generate_template_name)
    ...
    def _render_alert_manager_config(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration._render_alert_manager_config)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def _render_templates(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerConfiguration._render_templates)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
    ...
    def default_topic(self) -> typing.Optional[aws_cdk.aws_sns.ITopic]:
        ...
        :group: Resources
        '''
        return typing.cast(typing.Optional[aws_cdk.aws_sns.ITopic], jsii.get(self, "defaultTopic"))
...
class AlertManagerSnsDestination(
    ...
    def add_attribute(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerSnsDestination.add_attribute)
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertManagerSnsDestination.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [scope]))
...
class AlertingRule(
    ...
    def add_annotation(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertingRule.add_annotation)
            check_type(argname="argument label", value=label, expected_type=type_hints["label"])
            check_type(argname="argument template", value=template, expected_type=type_hints["template"])
    ...
    def add_label(self, label: builtins.str, template: builtins.str) -> "AlertingRule":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertingRule.add_label)
            check_type(argname="argument label", value=label, expected_type=type_hints["label"])
            check_type(argname="argument template", value=template, expected_type=type_hints["template"])
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AlertingRule.bind)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "bind", [_scope]))
    ...
    def period(self) -> typing.Optional[aws_cdk.Duration]:
        ...
        :group: Inputs
        '''
        return typing.cast(typing.Optional[aws_cdk.Duration], jsii.get(self, "period"))
