...
class LightningModel(pl.LightningModule):
    ...
    def training_epoch_end(self, training_step_outputs):
        ...
        path = f"{self.outputdir}/trained-epoch-{self.current_epoch}-train-loss-{str(self.average_training_loss)}-val-loss-{str(self.average_validation_loss)}"
...
class CustomT5:
    ...
    def from_pretrained(self, model_type="t5", model_name="t5-base") -> None:
        """
        loads T5/MT5 Model for training/finetuning
        Args:
