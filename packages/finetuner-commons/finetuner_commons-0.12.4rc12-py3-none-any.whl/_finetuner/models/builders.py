...
class EfficientNetB0Builder(_BackboneBuilder):
    """Build a CNN based model efficientnet_b0 using the torchvision library."""
    ...
    def build(self) -> nn.Module:
        ...
        return getattr(torchvision.models, self._descriptor)(
