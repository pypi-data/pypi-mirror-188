...
class GPRegressionBaseclass(ABC):
    ...
    def tune_hyperparams_pure_bayes(self, dataset, bounds = None, random_seed = 123,
    ...
    def tune_hyperparams_minimal_bayes(self, dataset, bounds = None, random_seed = 123,
        ...
        low risk of overfitting and is easy to use. We recommend using
