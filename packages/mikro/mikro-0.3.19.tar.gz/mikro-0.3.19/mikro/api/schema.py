...
from typing import Dict, Tuple, Optional, List, AsyncIterator, Literal, Iterator
...
class StageSizeInput(BaseModel):
    x: Optional[float]
    y: Optional[float]
    z: Optional[float]
...
class StageFragmentStagesize(BaseModel):
    typename: Optional[Literal["StageSize"]] = Field(alias="__typename")
    x: Optional[float]
...
class StageFragment(Stage, BaseModel):
    ...
    stage_size: Optional[StageFragmentStagesize] = Field(alias="stageSize")
...
class ListStageFragmentStagesize(BaseModel):
    typename: Optional[Literal["StageSize"]] = Field(alias="__typename")
    x: Optional[float]
    "pixelSize for x in microns"
    y: Optional[float]
...
class ListStageFragment(Stage, BaseModel):
    ...
    kind: Optional[AcquisitionKind]
    "The kind of acquisition"
    stage_size: Optional[ListStageFragmentStagesize] = Field(alias="stageSize")
    "The size of the stage"
...
class Create_stageMutation(BaseModel):
    ...
    class Arguments(BaseModel):
        ...
        stage_size: StageSizeInput

    class Meta:
        document = "fragment Stage on Stage {\n  id\n  kind\n  name\n  stageSize {\n    x\n    y\n    z\n  }\n}\n\nmutation create_stage($name: String!, $creator: ID, $instrument: ID, $tags: [String], $stage_size: StageSizeInput!) {\n  createStage(\n    name: $name\n    creator: $creator\n    instrument: $instrument\n    tags: $tags\n    stageSize: $stage_size\n  ) {\n    ...Stage\n  }\n}"
...
async def acreate_stage(
    ...
    Arguments:
        name (str): name
        stage_size (StageSizeInput): stage_size
        creator (Optional[ID], optional): creator.
