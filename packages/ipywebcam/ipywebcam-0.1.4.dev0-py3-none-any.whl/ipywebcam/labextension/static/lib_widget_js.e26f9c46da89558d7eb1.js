...
class WebCamModel extends base_1.DOMWidgetModel {
    ...
    constructor(...args) {
        ...
        this.closePeer = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (state === 'new' || state === 'ready') {
                throw new Error(`This should not happen. We can't close the peer when the state is ${state}. Because at this time, we shouldn't start the peer.`);
            }
        ...
        this.syncDevice = (track) => {
            ...
            if (track.kind === 'video') {
                ...
                if (curDeviceId !== deviceId) {
                    const devices = this.get('video_input_devices') || [];
                    const device = utils_1.arrayFind(devices, ({ deviceId }, ignored) => curDeviceId === deviceId);
            ...
            if (track.kind === 'audio') {
                ...
                if (curDeviceId !== deviceId) {
                    const devices = this.get('audio_input_devices') || [];
                    const device = utils_1.arrayFind(devices, ({ deviceId }, ignored) => curDeviceId === deviceId);
        ...
        this.connect = (video, force_reconnect = false, only_reconnect = false) => __awaiter(this, void 0, void 0, function* () {
            const state = yield this.waitForStateIn('closed', 'connected', 'error', 'ready');
    ...
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: WebCamModel.model_name, _model_module: WebCamModel.model_module, _model_module_version: WebCamModel.model_module_version, _view_name: WebCamModel.view_name, _view_module: WebCamModel.view_module, _view_module_version: WebCamModel.view_module_version, server_desc: null, client_desc: null, iceServers: [], constraints: null, video_input_devices: [], video_input_device: null, audio_input_devices: [], audio_input_device: null, audio_output_devices: [], audio_output_device: null, video_codecs: [], video_codec: null, state: 'new', autoplay: true, controls: true, crossOrigin: 'not-support', width: null, height: null, playsInline: true, muted: false });
    }
}
