...
class MultiRunner():
    def __init__(self,ini_dir="./ini/",result_dir="./results/",max_error_times=5,if_log=True,force_accelerate_end=False):
        if ini_dir[-1]!="/":
            ini_dir+="/"
        if result_dir[-1]!="/":
            result_dir+="/"
        ...
        self.if_log=if_log
        self.force_accelerate_end=force_accelerate_end
