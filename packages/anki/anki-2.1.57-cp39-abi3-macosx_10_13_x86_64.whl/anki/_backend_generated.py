...
class RustBackendGenerated:
    ...
    def update_deck_configs(self, *, target_deck_id: int, configs: Sequence[anki.deckconfig_pb2.DeckConfig], removed_config_ids: Sequence[int], apply_to_children: bool, card_state_customizer: str, limits: anki.deckconfig_pb2.DeckConfigsForUpdate.CurrentDeck.Limits) -> anki.collection_pb2.OpChanges:
        message = anki.deckconfig_pb2.UpdateDeckConfigsRequest(target_deck_id=target_deck_id, configs=configs, removed_config_ids=removed_config_ids, apply_to_children=apply_to_children, card_state_customizer=card_state_customizer, limits=limits)
