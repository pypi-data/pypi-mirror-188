...
def csvImporter(csv_folder, csv_folder_cleaned, db_table_name):
    ...
    for i in range(len(fileList)):
        if "Laptops" in fileList[i]:
            db_table_name = "tb_stackline_laptop"
        elif "Headphones" in fileList[i]:
            db_table_name = "tb_stackline_headphone"
        elif "Watches" in fileList[i]:
            db_table_name = "tb_stackline_watch"
        elif "Tablets" in fileList[i]:
            db_table_name = "tb_stackline_tablet"            
        elif "Phones" in fileList[i]:
            db_table_name = "tb_stackline_cell_phone"
