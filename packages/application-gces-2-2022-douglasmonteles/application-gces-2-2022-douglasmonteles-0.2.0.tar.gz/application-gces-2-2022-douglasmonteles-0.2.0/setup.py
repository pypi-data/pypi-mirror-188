...
['application',
 'application.source',
 'application.src',
 'application.src.data_pipeline',
 'application.src.data_pipeline.feature_engineering',
 'application.src.data_pipeline.pre_processing',
 'application.src.parser',
 'application.tests',
 'application.tests.data_pipeline',
 'application.tests.data_pipeline.feature_engineering',
 'application.tests.parser']
...
{'': ['*'],
 'application': ['.git/*',
                 ...
                 'metabase/config/*',
                 'scripts/*'],
 'application.src': ['yamls/*'],
 'application.tests': ['mock/*', 'mock/success/*']}
...
setup_kwargs = {
    'name': 'application-gces-2-2022-douglasmonteles',
    'version': '0.2.0',
    'description': '',
    ...
    'author': 'Douglas Monteles',
    'author_email': 'silvadouglas328@gmail.com',
    'maintainer': 'None',
