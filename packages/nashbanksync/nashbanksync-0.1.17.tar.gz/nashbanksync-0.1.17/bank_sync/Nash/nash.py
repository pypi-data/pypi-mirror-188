...
class Nash(Resource):
    ...
    def __init__(self, client_id=None, client_secret=None, auth_scope=None):
        ...
        if client_id and client_secret and auth_scope:
            self.login(client_id=client_id,
                       client_secret=client_secret, auth_scope=auth_scope)

    def login(self, client_id=None, client_secret=None, auth_scope=None):
        ...
        super().set_client_id(client_id=client_id)\
    ...
    def bank(self, bank_id=0):
        self._bank = Bank(self, bank_id).set_client_id(client_id=super().get_client_id())\
