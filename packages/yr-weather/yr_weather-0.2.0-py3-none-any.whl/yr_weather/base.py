...
class BaseClient():
    ...
    def _ensure_type(self, obj: Any, correct_type: Union[list, tuple, Any]):
        if isinstance(correct_type, (list, tuple)):
            if type(obj) in correct_type:
                return True
        
        if isinstance(obj, correct_type):
            return True
