...
def main():
    ...
    parser.add_argument('-cfg_type', required="-cfg" in sys.argv, choices=["pdf", "png"], help="The type of output file you want for -cfg", type=str)
    ...
    if args.o:
        ...
        emulator = Emulator(asm_obj, debug_val, args.cfg, args.cfg_type)
        emulator.start()
