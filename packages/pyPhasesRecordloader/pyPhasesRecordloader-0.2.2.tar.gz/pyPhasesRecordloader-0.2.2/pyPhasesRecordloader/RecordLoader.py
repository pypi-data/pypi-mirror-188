...
class RecordLoader:
    ...
    def __init__(self, filePath="", targetSignals=None, targetSignalTypes=None, optionalSignals=None, combineChannels=None, downloadOptions=None) -> None:
        ...
        optionalSignals = targetSignalTypes if targetSignalTypes is not None else []
