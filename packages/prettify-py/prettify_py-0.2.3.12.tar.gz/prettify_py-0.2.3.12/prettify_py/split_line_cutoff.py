...
def format_file_line_length(
    ...
    """
    The format_file_line_length function takes a file name, cutoff length
    and new file name as input. The function splits the lines in the original
    file after every word that is longer than the cutoff length.
    If no new_file_name is given, it will overwrite the original
    file with its formatted version.
