...
try:
    ...
    newset = input("INFO The `settings.txt` file does not exist. Do you want to create a new `settings.txt` file? (y/n)")
    if newset == 'y' or 'Y':
        ...
        print('INFO Please create a `settings.txt` file in the same directory as you are working in.')
        sys.exit()
