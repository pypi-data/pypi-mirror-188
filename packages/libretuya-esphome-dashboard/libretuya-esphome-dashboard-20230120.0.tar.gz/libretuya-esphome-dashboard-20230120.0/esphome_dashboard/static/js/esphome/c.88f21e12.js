import{E as e,G as t,M as c,_ as o,h as i,a as r,d as a,z as d,j as n,g as s,k as l,R as m,y as h,J as p,H as b,q as u,v as k,w as _,B as f,f as g,n as x,$ as v,a0 as y,a1 as w,a2 as $,a3 as S}from"./c.998383f4.js";import"./c.5b9dec44.js";import{F as C}from"./c.a0dcba7a.js";import{a as R,o as E,r as P,s as z}from"./index-25d4c1af.js";import{o as A,c as B}from"./c.ac9d788f.js";import{s as T,a as H,m as D,b as F,c as I}from"./c.1a700628.js";import{g as L,f as O,r as N}from"./c.a29a7bae.js";import{S as j,a as M,c as U,s as W}from"./c.65e44fc2.js";import{c as q}from"./c.440fff61.js";import{s as K}from"./c.a6e96e5a.js";import"./c.abbbe9de.js";import"./c.bc0ca5c5.js";const Y=Symbol("selection controller");class X{constructor(){this.selected=null,this.ordered=null,this.set=new Set}}class G{constructor(e){this.sets={},this.focusedSet=null,this.mouseIsDown=!1,this.updating=!1,e.addEventListener("keydown",(e=>{this.keyDownHandler(e)})),e.addEventListener("mousedown",(()=>{this.mousedownHandler()})),e.addEventListener("mouseup",(()=>{this.mouseupHandler()}))}static getController(e){const t=!("global"in e)||"global"in e&&e.global?document:e.getRootNode();let c=t[Y];return void 0===c&&(c=new G(t),t[Y]=c),c}keyDownHandler(e){const t=e.target;"checked"in t&&this.has(t)&&("ArrowRight"==e.key||"ArrowDown"==e.key?this.selectNext(t):"ArrowLeft"!=e.key&&"ArrowUp"!=e.key||this.selectPrevious(t))}mousedownHandler(){this.mouseIsDown=!0}mouseupHandler(){this.mouseIsDown=!1}has(e){return this.getSet(e.name).set.has(e)}selectPrevious(e){const t=this.getOrdered(e),c=t.indexOf(e),o=t[c-1]||t[t.length-1];return this.select(o),o}selectNext(e){const t=this.getOrdered(e),c=t.indexOf(e),o=t[c+1]||t[0];return this.select(o),o}select(e){e.click()}focus(e){if(this.mouseIsDown)return;const t=this.getSet(e.name),c=this.focusedSet;this.focusedSet=t,c!=t&&t.selected&&t.selected!=e&&t.selected.focus()}isAnySelected(e){const t=this.getSet(e.name);for(const e of t.set)if(e.checked)return!0;return!1}getOrdered(e){const t=this.getSet(e.name);return t.ordered||(t.ordered=Array.from(t.set),t.ordered.sort(((e,t)=>e.compareDocumentPosition(t)==Node.DOCUMENT_POSITION_PRECEDING?1:0))),t.ordered}getSet(e){return this.sets[e]||(this.sets[e]=new X),this.sets[e]}register(e){const t=e.name||e.getAttribute("name")||"",c=this.getSet(t);c.set.add(e),c.ordered=null}unregister(e){const t=this.getSet(e.name);t.set.delete(e),t.ordered=null,t.selected==e&&(t.selected=null)}update(e){if(this.updating)return;this.updating=!0;const t=this.getSet(e.name);if(e.checked){for(const c of t.set)c!=e&&(c.checked=!1);t.selected=e}if(this.isAnySelected(e))for(const e of t.set){if(void 0===e.formElementTabIndex)break;e.formElementTabIndex=e.checked?0:-1}this.updating=!1}}var V={NATIVE_CONTROL_SELECTOR:".mdc-radio__native-control"},J={DISABLED:"mdc-radio--disabled",ROOT:"mdc-radio"},Q=function(c){function o(e){return c.call(this,t(t({},o.defaultAdapter),e))||this}return e(o,c),Object.defineProperty(o,"cssClasses",{get:function(){return J},enumerable:!1,configurable:!0}),Object.defineProperty(o,"strings",{get:function(){return V},enumerable:!1,configurable:!0}),Object.defineProperty(o,"defaultAdapter",{get:function(){return{addClass:function(){},removeClass:function(){},setNativeControlDisabled:function(){}}},enumerable:!1,configurable:!0}),o.prototype.setDisabled=function(e){var t=o.cssClasses.DISABLED;this.adapter.setNativeControlDisabled(e),e?this.adapter.addClass(t):this.adapter.removeClass(t)},o}(c);class Z extends C{constructor(){super(...arguments),this._checked=!1,this.useStateLayerCustomProperties=!1,this.global=!1,this.disabled=!1,this.value="on",this.name="",this.reducedTouchTarget=!1,this.mdcFoundationClass=Q,this.formElementTabIndex=0,this.focused=!1,this.shouldRenderRipple=!1,this.rippleElement=null,this.rippleHandlers=new m((()=>(this.shouldRenderRipple=!0,this.ripple.then((e=>{this.rippleElement=e})),this.ripple)))}get checked(){return this._checked}set checked(e){var t,c;const o=this._checked;e!==o&&(this._checked=e,this.formElement&&(this.formElement.checked=e),null===(t=this._selectionController)||void 0===t||t.update(this),!1===e&&(null===(c=this.formElement)||void 0===c||c.blur()),this.requestUpdate("checked",o),this.dispatchEvent(new Event("checked",{bubbles:!0,composed:!0})))}_handleUpdatedValue(e){this.formElement.value=e}renderRipple(){return this.shouldRenderRipple?h`<mwc-ripple unbounded accent
    ...
    `}_renderAskESPHomeWeb(){return["New device",h`
      ...
      <div>
        ${F?"Your browser does not support WebSerial.":"You are not browsing the dashboard over a secure connection (HTTPS)."}
    ...
    `,!1]}_renderBasicConfig(){if(void 0===this._hasWifiSecrets)return[void 0,this._renderProgress("Initializing"),!0];return[T?"New device":"Create configuration",h`
      ...
      <mwc-button
        ...
        label="Cancel"
      ></mwc-button>
    `,!1]}_renderPickPlatform(){return h`
      ${this._error?h`<div class="error">${this._error}</div>`:""}
      ...
      <mwc-button
        ...
        label="Cancel"
      ></mwc-button>
    `}_renderPickBoard(){const e=this._platformData().defaultBoard;let t=null;if(e&&this._supportedBoards)for(let c of this._supportedBoards)if(e in c.items){t=c.items[e];break}return h`
      ${this._error?h`<div class="error">${this._error}</div>`:""}
      ${this._supportedBoards?h`
            <select
              @change=${this._handlePickBoardSelect}
              size="15"
              style="width: 100%;"
            >
              ${e&&t?h`<option value="${e}" selected>
                      ${t} (default)
                    </option>
                    <option disabled>------</option>`:""}
              ${this._supportedBoards.map((t=>{const c=Object.keys(t.items).map((c=>c===e?h``:h`<option value="${c}">${t.items[c]}</option>`));return t.title?h`<optgroup label="${t.title}">${c}</optgroup>`:c}))}
            </select>
          `:h`<div>Loading board list...</div>`}
    ...
    `}_renderDone(){return this._error?this._renderMessage("👀",this._error,!0):h`
      ...
      ${this._installed?h`
          ...
          `:h`
            ...
            ></mwc-button>
          `}
    `}firstUpdated(e){super.firstUpdated(e),U().then((e=>{this._hasWifiSecrets=e}))}updated(e){if(super.updated(e),e.has("_state")||e.has("_hasWifiSecrets")){const e=this.shadowRoot.querySelector("mwc-textfield, mwc-radio, mwc-button");e&&e.updateComplete.then((()=>e.focus()))}if("pick_board"==this._state){if(e.has("_state")){(e=>g(`./boards/${e}`))(this._platform.toLowerCase()).then((e=>{this._supportedBoards=e,this._busy=!1}))}if(e.has("_busy")&&!this._busy){const e=this.shadowRoot.querySelector("select");e&&e.focus()}}}async _handleBasicConfigSubmit(){const e=this._inputName,t=e.reportValidity(),c=!!this._hasWifiSecrets||this._inputSSID.reportValidity();if(!t)return void e.focus();if(!c)return void this._inputSSID.focus();const o=e.value;this._data.name=o,this._hasWifiSecrets||(this._wifi={ssid:this._inputSSID.value,password:this._inputPassword.value}),setTimeout((()=>{this._state=T&&F?"connect_webserial":"pick_platform"}),0)}_handleUseRecommendedCheckbox(e){this._useRecommended=e.target.checked}_handlePickBoardSelect(e){this._board=e.target.value}async _handlePickPlatformClick(e){this._supportedBoards=void 0,this._platform=e.currentTarget.platform,this._board=this._platformData().defaultBoard,this._useRecommended&&null!==this._board?await this._handlePickBoardSubmit():(this._busy=!0,this._state="pick_board")}async _handlePickBoardSubmit(){if(this._board){this._data.board=this._board,this._busy=!0;try{this._wifi&&await W(this._wifi.ssid,this._wifi.password);const e=await v(this._data);this._configFilename=e.configuration,this._apiKey=await y(this._configFilename),P(),this._state="done"}catch(e){this._error=e.message||e}finally{this._busy=!1}}}_handleConnectSerialSkip(){this._error=void 0,this._state="pick_platform"}async _handleConnectSerialSubmit(){var e;let t;this._busy=!0,this._error=void 0;let c=!1;try{let o,i;try{o=await navigator.serial.requestPort()}catch(e){return console.error(e),void("NotFoundError"===e.name?A():this._error=e.message||String(e))}t=B(o),this._state="connecting_webserial";try{await t.main_fn(),await t.flash_id()}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Failed to initialize. Try resetting your device or holding the BOOT button while selecting your serial port until it starts preparing the installation.")}this._state="prepare_flash";const r=t.chip.CHIP_NAME;if(!Object.keys(I).includes(r))return this._state="connect_webserial",void(this._error=`Unable to identify the connected device (${t.chip.CHIP_NAME}).`);i=I[r],this._data.board=null!==(e=H[i].defaultBoard)&&void 0!==e?e:void 0;try{const{configuration:e}=await v(this._data);this._configFilename=e}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Unable to create the configuration")}c=!0;try{await w(this._configFilename)}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Unable to compile the configuration")}this._state="flashing";try{const e=await L(this._configFilename);await O(t,e,!0,(e=>{this._writeProgress=e}))}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Error installing the configuration")}c=!1,this._installed=!0,await N(t.transport),this._state="wait_come_online";try{await new Promise(((e,t)=>{const c=z((t=>{t[this._configFilename]&&(c(),clearTimeout(o),e(void 0))})),o=setTimeout((()=>{c(),t("Timeout")}),2e4)}))}catch(e){console.error(e),this._error="Configuration created but unable to detect the device on the network"}this._state="done"}finally{this._busy=!1,t&&(console.log("Closing port"),await t.transport.disconnect()),c&&await $(this._configFilename)}}async _handleClose(){this.parentNode.removeChild(this)}async _handleCopyApiKey(){var e;q(this._apiKey),this._inputApiKeyBanner.style.setProperty("display","flex"),await K(3e3),null===(e=this._inputApiKeyBanner)||void 0===e||e.style.setProperty("display","none")}};me.styles=[S,k`
      :host {
