...
def get_metric_batch_configs(config_dir):
    metric_batch_configs = [f'{config_dir}/{f}'.replace('//','/') for f in os.listdir(config_dir)]
...
def get_metric_batch_config_defaults(config_dir):
    metric_batch_configs_defaults = [f'{config_dir}/{f}'.replace('//','/') for f in os.listdir(config_dir)]
