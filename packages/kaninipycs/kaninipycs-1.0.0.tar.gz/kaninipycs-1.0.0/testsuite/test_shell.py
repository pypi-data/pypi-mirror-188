...
class ShellTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._saved_pconfig = kaninipycs.PROJECT_CONFIG
        self._saved_cpread = configparser.RawConfigParser._read
        self._saved_stdin_get_value = kaninipycs.stdin_get_value
        ...
        kaninipycs.stdin_get_value = self.stdin_get_value

    def tearDown(self):
        sys.argv = self._saved_argv
        sys.stdout = self._saved_stdout
        sys.stderr = self._saved_stderr
        kaninipycs.PROJECT_CONFIG = self._saved_pconfig
        configparser.RawConfigParser._read = self._saved_cpread
        kaninipycs.stdin_get_value = self._saved_stdin_get_value
