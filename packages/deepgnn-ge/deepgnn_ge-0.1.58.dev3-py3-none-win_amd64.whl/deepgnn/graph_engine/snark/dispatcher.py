...
class PipeDispatcher(Dispatcher):
    ...
    def __init__(
        ...
        Args:
            ...
            is_temporal(bool): add timestamps to graph elements.
            watermark(int): largest timestamp.
        """
        super().__init__()
    ...
    * partition_func may be used to distribute nodes to desired partitions
    ...
    def __init__(
        ...
        Args:
            ...
            skip_node_sampler(bool): skip generation of node alias tables.
            skip_edge_sampler(bool): skip generation of edge alias tables.
            is_temporal(bool): process timestamps for graph elements.
            watermark(int): largest known timestamp.
        """
        super().__init__()
