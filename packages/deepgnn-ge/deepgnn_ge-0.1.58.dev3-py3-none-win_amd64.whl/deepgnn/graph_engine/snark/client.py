...
class MemoryGraph:
    ...
    def node_features(
        ...
        Args:
            ...
            timestamps (Union[List[int], np.ndarray], optional): list of timestamps to extract features per node
    ...
    def edge_features(
        ...
        Args:
            ...
            timestamps (Union[List[int], np.ndarray], optional): list of timestamps to extract features per edge
    ...
    def neighbor_counts(
        ...
        Args:
            nodes (np.ndarray): array of nodes to select neighbors
            edge_types (Union[List[int], int): type of edges to use for selection
            timestamps (Union[List[int], np.ndarray], optional): list of timestamps to extract neighbor counts for each node
    ...
    def weighted_sample_neighbors(
        ...
        Args:
            ...
            timestamps (Union[List[int], np.ndarray]): timestamps of node to sample neighbors from the graph.
        Returns:
    ...
    def uniform_sample_neighbors(
        ...
        Args:
            ...
            seed (int, optional): Seed value for random samplers. Defaults to random.getrandbits(64).
            timestamps (Union[List[int], np.ndarray], optional): list of timestamps to sample neighbors per node
