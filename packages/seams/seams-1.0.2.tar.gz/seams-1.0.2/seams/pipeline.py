...
class Pipeline(ABC):
    ...
    def __get_parameters(self):
        ...
        if not args.vertex_id:
            attributes = {
                "dateSubmitted": "",
                "status": "SUBMITTED"
                "runParameters": '{"Test": "Doesnt Matter"}',
                "pipelineId": "NEED TO FIGURE THIS OUT"
                "pipeLineName": "NEED TO FIGURE THIS OUT"
            }

            new_pipeline_run = seams.create_vertex(args.tenant_id, "PipelineRun", "NEED TO FIGURE THIS OUT", attributes)
