    ...
    def __get_parameters(self):
        ...
        if args.pipeline_name:
            attributes = {
                "dateSubmitted": "",
                "status": "SUBMITTED",
                "runParameters": '{"Test": "Doesnt Matter"}',
                "pipelineId": args.vertex_id,
                "pipeLineName": args.pipeline_name
            }
            pipeline_name = args.pipeline_name.lower().replace(" ", "-") + "-" + str(int((time.mktime(datetime.datetime.now().timetuple()))))
            ...
            self.vertex_id = new_pipeline_run["id"]
        else:
            self.vertex_id = args.vertex_id

        parameters = {"tenant_id": args.tenant_id, "vertex_id": self.vertex_id}
        return parameters
