...
from robin_sd_upload.supportive_scripts.validate import validate
from robin_sd_upload.supportive_scripts.create_zip import create_zip
from robin_sd_upload.supportive_scripts.remove_zip import remove_zip
from  robin_sd_upload.supportive_scripts.check_upload_file import check_upload_file
...
def arg_parser():
    ...
    if args.check:
        ...
        push_software(zipped_file_path, radarType, version_name)
