...
def profile(
    ...
    data_set_resource = resources.read(dict(type="data set", name=name))
    profile_resources = [
        dict(
            type="data service",
            name=name,
        ...
        dict(
            ...
            dataSet=name,
            blocks=[
                dict(name="Univariate analysis", type="univariate analysis"),
                dict(
    ...
    return [
        dict(type=resource.get("type", "flow"), name=resource["name"])
