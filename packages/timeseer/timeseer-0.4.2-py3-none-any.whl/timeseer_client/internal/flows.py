...
class Flows:
    ...
    def duplicate(  # pylint:disable=too-many-arguments
        self,
...
def evaluate_flow(
    ...
    *,
    ...
    if block:
        wait_for_flow_evaluation(client, response)


def wait_for_flow_evaluation(client: JSONFlightClient, response: Dict):
