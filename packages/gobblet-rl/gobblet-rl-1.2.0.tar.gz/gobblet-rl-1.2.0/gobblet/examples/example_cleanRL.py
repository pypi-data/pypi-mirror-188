...
if __name__ == "__main__":
    ...
    """ ENV SETUP """
    env = gobblet_v1.parallel_env(render_mode="human")
    ...
    for episode in range(total_episodes):
        ...
        with torch.no_grad():
            ...
            for step in range(0, max_cycles):
                ...
                obs = [ next_obs[agent]['observation'] for agent in next_obs.keys() ]
                action_mask = [ next_obs[agent]['action_mask'] for agent in next_obs.keys() ]
    ...
    """ RENDER THE POLICY """
    env = gobblet_v1.parallel_env(render_mode="human", continuous=False)
