...
def option_readme(args):
    ...
    {utils.CYELLOW}Parsed output fields:{utils.CEND}
     ...
     - {utils.CGREEN}Q{utils.CEND}: Total queries performed by the user APEX program. This field is accurate.
     - {utils.CGREEN}Qcm{utils.CEND}: Total queries performed by the managed package. We do not have control when they appear. 
                Adding this APEX line in the code will increase the accuracy for manage package queries: {utils.CGREEN}System.debug('*** getQueries() *** Measured: ' + Limits.getQueries());{utils.CEND}
     - {utils.CGREEN}Qe{utils.CEND}: Estimate queries performed by the managed package. This is an estimate for the manage package queries. Mostly accurate. 
