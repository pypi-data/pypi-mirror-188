...
class RtaCmd:
    ...
    def move_w_ramp_steps_cmd(self, steps, rpm, direction):
        ...
        return f'{self.drive_address:02d}WN,{self.mem_addr:03d},{InstCode.HI_RUN_RAMP},' \
               f'{240:03d},{self.ramp_code},{direction}{steps},x{self.multiplier},{self.next_inst_addr:03d}{self.CR}' #
    ...
    def move_w_ramp_free_cmd(self, hz, direction):
        ...
        """
        return f'{self.drive_address:02d}WN,{self.mem_addr:03d},{InstCode.HI_FREE_RUN_RAMP},' \
               f'{hz},{self.ramp_code},{direction},x{self.multiplier},{self.next_inst_addr:03d}{self.CR}' # hz:04d
    ...
    def move_no_ramp_free_cmd(self, rpm, direction):
        ...
        :return:
        """
        hz = rpm # self.rpm2hz(rpm)
        return f'{self.drive_address:02d}WN,{self.mem_addr:03d},{InstCode.HI_FREE_RUN_NO_RAMP},' \
               f'{rpm:04d},{direction},x{self.multiplier},{self.next_inst_addr:03d}{self.CR}'
