...
function GetOciSubcommands_opsi() {
    $ociSubcommands = @{
        'opsi' = 'awr-hubs database-insights enterprise-manager-bridges exadata-insights host-insights operations-insights-warehouse-users operations-insights-warehouses opsi-data-objects opsi-private-endpoint work-requests'
...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi database-insights summarize-database-insight-resource-forecast-trend' = 'analysis-time-interval cdb-name compartment-id compartment-id-in-subtree confidence database-id database-type defined-tag-equals defined-tag-exists exadata-insight-id forecast-days forecast-model freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric statistic tablespace-name time-interval-end time-interval-start utilization-level vmcluster-name'
        'opsi database-insights summarize-database-insight-resource-statistics' = 'analysis-time-interval cdb-name compartment-id compartment-id-in-subtree database-id database-type defined-tag-equals defined-tag-exists exadata-insight-id forecast-days freeform-tag-equals freeform-tag-exists from-json help host-name id insight-by is-database-instance-level-metrics limit page percentile resource-metric sort-by sort-order time-interval-end time-interval-start vmcluster-name'
        'opsi database-insights summarize-database-insight-resource-usage' = 'analysis-time-interval compartment-id compartment-id-in-subtree database-id database-type defined-tag-equals defined-tag-exists exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page percentile resource-metric time-interval-end time-interval-start vmcluster-name'
        'opsi database-insights summarize-database-insight-resource-usage-trend' = 'analysis-time-interval compartment-id compartment-id-in-subtree database-id database-type defined-tag-equals defined-tag-exists exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric sort-by sort-order time-interval-end time-interval-start vmcluster-name'
        'opsi database-insights summarize-database-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id compartment-id-in-subtree database-id database-type defined-tag-equals defined-tag-exists exadata-insight-id forecast-days freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric time-interval-end time-interval-start vmcluster-name'
        ...
        'opsi host-insights summarize-top-processes-usage-trend' = 'analysis-time-interval compartment-id from-json help host-id host-type id limit page resource-metric time-interval-end time-interval-start'
