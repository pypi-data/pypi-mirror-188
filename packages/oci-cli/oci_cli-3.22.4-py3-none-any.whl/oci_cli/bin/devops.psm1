...
function GetOciCommandsToLongParams_devops() {
    $ociCommandsToLongParams = @{
        ...
        'devops deployment create-pipeline-deployment' = 'artifact-override-arguments defined-tags deployment-arguments display-name freeform-tags from-json help max-wait-seconds pipeline-id stage-override-arguments wait-for-state wait-interval-seconds'
        ...
        'devops deployment create-single-stage-deployment' = 'artifact-override-arguments defined-tags deployment-arguments display-name freeform-tags from-json help max-wait-seconds pipeline-id stage-id stage-override-arguments wait-for-state wait-interval-seconds'
