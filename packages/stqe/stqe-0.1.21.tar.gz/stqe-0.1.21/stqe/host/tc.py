...
class TestClass:
    ...
    def __init__(self, reload_logs=False):
        # reload_logs: in case of tests that support reboots we need to reload previous logs
        # by default if test log file exists assume is from previous test that didn't clean up properly and ignore it...
        if not reload_logs:
