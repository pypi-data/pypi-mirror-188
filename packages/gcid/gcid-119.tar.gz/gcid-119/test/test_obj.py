...
from gcid.objects import Object, Wd, items, keys, register, update, values
from gcid.objects import edit, kind, fmt, load, save
from gcid.objects import ObjectDecoder, ObjectEncoder
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "gcid.objects.Object")
