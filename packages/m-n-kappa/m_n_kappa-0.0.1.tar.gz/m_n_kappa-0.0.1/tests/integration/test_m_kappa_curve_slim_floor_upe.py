    ...
    def test_not_successful(self):
        ...
        self.assertListEqual(
            self.m_kappa_curve.not_successful, [
                ...
                [StrainPosition(strain=-0.0013952380952380952, position=144, material='Steel'), same_sign],
                [StrainPosition(strain=-0.0014904761904761905, position=220.0, material='Steel'), same_sign],
                [StrainPosition(strain=-0.00279, position=10.0, material='Reinforcement'), same_sign],
                [StrainPosition(strain=-0.00297, position=210, material='Reinforcement'), same_sign],
            ])
...
class TestSlimFloorUPEPositiveWithEffectiveWidth(TestCase):
    ...
    def setUp(self) -> None:
        self.m_kappa_curve = MKappaCurve(cross_section, EffectiveWidths(membran=473.7, bending=1364.8))
