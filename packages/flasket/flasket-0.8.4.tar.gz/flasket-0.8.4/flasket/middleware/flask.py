...
.. code-block:: python
  ...
  from flasket import create

  if __name__ == "__main__":
      flasket = create(__file__, "flask", cfgname="example.yml")
      flasket.run()
...
class FlaskFlasketCreator:
    @staticmethod
    def flasket(*args: t.Any, **kwargs: t.Any) -> Flasket:
        app = Flasket(*args, **kwargs)
        return app

    @staticmethod
    def force_cfg(_cfg: t.Dict["str", t.Any]) -> None:
        return
