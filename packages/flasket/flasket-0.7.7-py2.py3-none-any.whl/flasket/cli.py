...
class ABCFlasketCLI(abc.ABC, _DefaultCfgMixin):
    ...
    def run(self, *args: t.Any, argv: t.List[str] = None, rootpath: str = None, test:bool=False, **kwargs: t.Any):
        """
        ...
        with self.ctx():
            ...
            app = self._run(*args, cfg=cfg, rootpath=rootpath, test=test, **kwargs)
            if test:
                return app
            sys.exit(0)
