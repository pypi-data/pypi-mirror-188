...
.. autoclass:: Flasket
  :show-inheritance:
  :members: baseurl, clients, config, current_app, debug, flask, handlers, host, logger, make_response, port, redirect, render_template, request, rootpath, session, sitename,
...
from .handlers._utils import BaseHandler, Handler, handler
...
class Flasket(BaseHandler):
    ...
    @property
    def handlers(self) -> t.Dict[str, Handler]:
        """
