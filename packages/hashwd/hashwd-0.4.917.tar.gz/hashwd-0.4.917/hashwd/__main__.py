...
def main():
    ...
    pass_defaults_path = os.path.join(script_dir, "lib", "site-packages", "hashwd", "pass_defaults.py")
    ...
    if args.command == "generate":
        hashwd.hashwd.generate_password(hashwd.pass_defaults.DICTIONARY_FILE, word_quantity=hashwd.pass_defaults.WORDS_DEFAULT,
                          number_quantity=hashwd.pass_defaults.NUMBERS_DEFAULT, symbol_quantity=hashwd.pass_defaults.SYMBOLS_DEFAULT)

        password = hashwd.hashwd.generate_password(hashwd.pass_defaults.DICTIONARY_FILE, num_words, num_numbers, num_symbols)
