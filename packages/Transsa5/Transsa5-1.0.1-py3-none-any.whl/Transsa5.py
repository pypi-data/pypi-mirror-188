...
def Entrenamiento(df2, t_s):
    Xrlinter = np.array(df2[["ingreso",'Index_antiguedad_10','longitud','latitud','supCSII','supTSII',"avaluofiscal"]])
...
def Xrl_inter(remL):
    indexaciones=['ingreso','Index_antiguedad_10','longitud','latitud','supCSII','supTSII','avaluofiscal']
...
def ModeloFinal(reml2,scls,models,cve): ### MOD X TENER RL Y ENET
