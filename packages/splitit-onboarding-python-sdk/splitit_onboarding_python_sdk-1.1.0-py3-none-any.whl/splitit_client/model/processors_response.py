...
class ProcessorsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'processors': ([ProcessorResponse],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, processors, *args, **kwargs):  # noqa: E501
        """ProcessorsResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, processors, *args, **kwargs):  # noqa: E501
        """ProcessorsResponse - a model defined in OpenAPI
