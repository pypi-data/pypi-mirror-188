...
class TransferL0Data(WorkflowTaskBase, GlobusMixin, InputDatasetMixin):
    ...
    def format_frame_transfer_items(self) -> list[GlobusTransferItem]:
        ...
        return self._format_transfer_items(self.input_dataset_frames)
    ...
    def format_parameter_transfer_items(self) -> list[GlobusTransferItem]:
        ...
        return self._format_transfer_items(self.input_dataset_parameter_objects)
    ...
    def tag_parameter_files(self, transfer_items: list[GlobusTransferItem]) -> None:
        """
        Tag all the parameter files with 'parameter_file'.
    ...
    def run(self) -> None:
        ...
        with self.apm_processing_step("Tag Input Frames and Parameter Files"):
            ...
            self.tag_parameter_files(transfer_items=parameter_transfer_items)
