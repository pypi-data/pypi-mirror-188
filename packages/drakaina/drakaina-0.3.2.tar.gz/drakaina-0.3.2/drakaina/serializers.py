...
class BaseJsonSerializer(BaseSerializer):
    ...
    def deserialize(self, s: Union[bytes, str]) -> Any:
        try:
            return self.loads(s)
        except (self.DecodeError, ValueError):
            raise ParseError
...
class ORJsonSerializer(BaseJsonSerializer):
    ...
    def serialize(self, obj: Any) -> bytes:
        ...
        except (orjson.JSONEncodeError, RecursionError, TypeError, ValueError):
            raise InternalError
...
class MSGPackSerializer(BaseSerializer):
    ...
    def deserialize(self, s: Union[bytes, str, RawIOBase]) -> Any:
        ...
        except (msgpack.UnpackException, TypeError, ValueError):
            raise ParseError
