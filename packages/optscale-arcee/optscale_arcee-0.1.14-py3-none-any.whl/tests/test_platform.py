...
from optscale_arcee.sender.platform import (
    Platform,
    AzureCollector,
    CollectorFactory,
    PlatformType,
...
from optscale_arcee.tests.test_data import TestDataAzure
...
class TestPlatform(IsolatedAsyncioTestCase):
    ...
    @patch("optscale_arcee.sender.platform.Platform.sys_vendor")
...
class TestAzureCollector(IsolatedAsyncioTestCase):
    @patch("optscale_arcee.sender.platform.AzureCollector.collect")
...
class TestAwsCollector(IsolatedAsyncioTestCase):
    @patch("optscale_arcee.sender.platform.AwsCollector.get_instance_type")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_region")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_az")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_life_cycle")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_public_ip")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_local_ip")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_account_id")
    @patch("optscale_arcee.sender.platform.AwsCollector.get_instance_id")
