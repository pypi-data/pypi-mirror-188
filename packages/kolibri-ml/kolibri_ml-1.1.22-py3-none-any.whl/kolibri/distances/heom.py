...
class HEOM(BaseDistance):
    def __init__(self, X, cat_ix, nan_equivalents=[np.nan, 0], normalised="normal", encode_categories=True):
    ...
    def get_distance(self, x, y):
        ...
        results_array[num_ix] = 10*(np.abs(x[num_ix] - y[num_ix]) / self.range[num_ix])
