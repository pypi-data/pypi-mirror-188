...
class PulsarQcm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.7.2 fwBuild=28/07/2022-16:06:31 fwHash=0xAE241402 fwDirty=0 kmodVersion=0.7.3 kmodBuild=24/01/2023-11:04:28 kmodHash=0x5DE3F8CD kmodDirty=0 swVersion=0.7.3 swBuild=24/01/2023-11:04:28 swHash=0x5DE3F8CD swDirty=0 cfgManVersion=0.2.0 cfgManBuild=24/01/2023-11:04:28 cfgManHash=0x5DE3F8CD cfgManDirty=0"
            if build != build_ref:
