...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.7.2 fwBuild=28/07/2022-16:05:59 fwHash=0xB5C9673B fwDirty=0 kmodVersion=0.7.3 kmodBuild=24/01/2023-11:05:06 kmodHash=0x6D856959 kmodDirty=0 swVersion=0.7.3 swBuild=24/01/2023-11:05:06 swHash=0x6D856959 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=24/01/2023-11:05:06 cfgManHash=0x6D856959 cfgManDirty=0"
            if build != build_ref:
