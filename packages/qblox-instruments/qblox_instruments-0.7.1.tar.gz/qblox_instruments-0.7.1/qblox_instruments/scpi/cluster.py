...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.2.2 fwBuild=28/07/2022-16:02:41 fwHash=0x22F638E7 fwDirty=0 kmodVersion=0.2.3 kmodBuild=24/01/2023-11:32:11 kmodHash=0xA2E77056 kmodDirty=0 swVersion=0.2.3 swBuild=24/01/2023-11:32:11 swHash=0xA2E77056 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=24/01/2023-11:32:11 cfgManHash=0xA2E77056 cfgManDirty=0"
            if build != build_ref:
