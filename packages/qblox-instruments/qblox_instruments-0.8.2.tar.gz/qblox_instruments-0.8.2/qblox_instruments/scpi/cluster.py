...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.3.0 fwBuild=08/12/2022-11:14:46 fwHash=0x2CC18B28 fwDirty=0 kmodVersion=0.3.1 kmodBuild=25/01/2023-10:14:23 kmodHash=0x54366251 kmodDirty=0 swVersion=0.3.1 swBuild=25/01/2023-10:14:23 swHash=0x54366251 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=25/01/2023-10:14:23 cfgManHash=0x54366251 cfgManDirty=0"
            if build != build_ref:
