...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.8.0 fwBuild=08/12/2022-11:24:20 fwHash=0xC88A7164 fwDirty=0 kmodVersion=0.8.0 kmodBuild=08/12/2022-11:24:20 kmodHash=0xC88A7164 kmodDirty=0 swVersion=0.8.0 swBuild=08/12/2022-11:24:20 swHash=0xC88A7164 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=08/12/2022-11:24:20 cfgManHash=0xC88A7164 cfgManDirty=0"
            if build != build_ref:
