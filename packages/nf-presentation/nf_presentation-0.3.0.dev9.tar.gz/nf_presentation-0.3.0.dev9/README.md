...
3. [x] коспект из методички рфс 6 пунктов -> инфо слайд треинровки
4. [ ] Где в training_data лежат анимации
   1. [ ] Можно ли получить исходный формат exercise_info как в nanofootball.com/exercises
5. [x] Использовать схемы из новой рисовалки при возможности
6. [x] Левая таблица названия капсом
7. [x] Тестирование
8.  [x] 12 Шрифт
9.  [x] Добавить слияние ячеек в таблице, если есть пустые строки
10. [X] Создать абстрактный класс, который бы мог работать как с упражнениями из событий так и обычными, а может потом будет ещё какая-то новая структура. Надо быть готовым :(
11. [x] Настроить логгер вместо print(..)
12. [x] ~~Устранить утечку памяти где создается поток для объектак. Используя with~~
13. [x] ~~Презентация в широком формате~~
14. [x] ~~Новое форматирование~~
15. [x] Размер шрифта
16. [ ] Цели в левой таблице, текст по центру колонки
17. [ ] Создание презентации из двустороннего шаблона
18. [ ] Цвета
