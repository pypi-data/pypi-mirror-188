...
clad = Fused4(fiber_radius=62.5, fusion_degree=0.6, index=index)
...
cores = [Circle(position=fiber.core, radius=4.1, index=index + 0.005) for fiber in clad.fiber_list]
...
Sol = SuPySolver(geometry=geometry, tolerance=1e-8, max_iter=10000)

Sol.init_superset(wavelength=1.55, n_step=500, itr_i=1.0, itr_f=0.05)
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
_ = Set.plot(type='field', itr_list=[1.0, 0.05]).show()
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
_ = Set.plot(type='index').show()

# %%
# Modal coupling: :math:`C_{i,j}`
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
_ = Set.plot(type='coupling').show()

# %%
# Adiabatic criterion: :math:`\tilde{C}_{i,j}`
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
_ = Set.plot(type='adiabatic').show()
