...
def test_basecube_subscription_handler_datachange_earthingstickstatus(
    ...
    for i in earthing_stick._EarthingStick._STICKS:
        demo_opcua_server.set_var(
            ...
            int(earthing_stick.EarthingStickStatus.INACTIVE),
        )
    ...
    for i in earthing_stick._EarthingStick._STICKS:
        demo_opcua_server.set_var(
            earthing_stick._EarthingStick("", i)._CMD_STATUS,
            int(earthing_stick.EarthingStickStatus.CLOSED),
        )
    sleep(0.05)
...
def test_get_earthing_stick_status(cube: BaseCube, demo_opcua_server: DemoServer):
    ...
    assert cube.earthing_stick_1.status == earthing_stick.EarthingStickStatus(1)
...
def test_get_earthing_stick_operating_status(
    ...
    demo_opcua_server.set_var(
        ...
        earthing_stick.EarthingStickOperatingStatus.AUTO,
    )
    assert (
        cube.earthing_stick_1.operating_status
        is earthing_stick.EarthingStickOperatingStatus.AUTO
    )
...
def test_get_earthing_stick_manual(cube: BaseCube, demo_opcua_server: DemoServer):
    demo_opcua_server.set_var(
        ...
        bool(earthing_stick.EarthingStickOperation.CLOSE),
    )
    assert cube.earthing_stick_1.operate is earthing_stick.EarthingStickOperation.CLOSE


def test_operate_earthing_stick(cube: BaseCube, demo_opcua_server: DemoServer):
    demo_opcua_server.set_var(
        earthing_stick._EarthingStick("", 1)._CMD_OPERATING_STATUS,
        earthing_stick.EarthingStickOperatingStatus.MANUAL,
    )
    demo_opcua_server.set_var(
        earthing_stick._EarthingStick("", 1)._CMD_MANUAL,
        bool(earthing_stick.EarthingStickOperation.OPEN),
    )
    ...
    assert cube.earthing_stick_1.operate is earthing_stick.EarthingStickOperation.OPEN
    cube.earthing_stick_1.operate = earthing_stick.EarthingStickOperation.CLOSE
    assert cube.earthing_stick_1.operate is earthing_stick.EarthingStickOperation.CLOSE
    ...
    cube.earthing_stick_1.operate = earthing_stick.EarthingStickOperation.OPEN
    assert cube.earthing_stick_1.operate is earthing_stick.EarthingStickOperation.OPEN
    cube.earthing_stick_1.operate = earthing_stick.EarthingStickOperation.CLOSE
    assert cube.earthing_stick_1.operate is earthing_stick.EarthingStickOperation.CLOSE
