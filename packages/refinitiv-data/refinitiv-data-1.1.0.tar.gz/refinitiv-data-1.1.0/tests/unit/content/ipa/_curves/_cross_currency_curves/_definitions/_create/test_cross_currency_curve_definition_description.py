...
from refinitiv.data.content.ipa._curves._cross_currency_curves._definitions._create import (
    CrossCurrencyCurveDefinitionDescription,
)


def test_cross_currency_curve_definition_description():
    # given
    expected_dict = {
    ...
    # when
    testing_obj = CrossCurrencyCurveDefinitionDescription(
    ...
    assert testing_obj.is_fallback_for_fx_curve_definition is True
