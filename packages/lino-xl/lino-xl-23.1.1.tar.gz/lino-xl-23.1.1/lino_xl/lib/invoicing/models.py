...
class Plan(UserPlan):
    ...
    def fill_plan(self, ar):
        # print("20221224 fill plan.target_journal is", self.target_journal)
        self.full_clean()
        ...
        for ig in self.get_generators_for_plan(self.partner):
            ...
            # print("20221223 gonna make invoice", invoice, invoice_items)
