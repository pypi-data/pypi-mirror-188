...
from kaiju_tools.services import ContextableService, ServiceOfServices, RequestContext, Session, Scope, SystemSession
...
class JSONRPCServer(ContextableService, ServiceOfServices):
    ...
    @staticmethod
    def get_session() -> Union[SystemSession, object]:
    ...
    async def _execute_request(
        ...
        if self._enable_permissions:
            if method['permission'].value < scope.value and request.method not in session['permissions']:
