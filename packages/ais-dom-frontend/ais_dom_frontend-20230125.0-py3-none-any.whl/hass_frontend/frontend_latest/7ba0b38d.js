/*! For license information please see 7ba0b38d.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[51882],{27530:(e,t,i)=>{i.d(t,{t:()=>a});var s=i(57835),o=i(37500),r=i(76187);const n=Symbol("valueNotInitialized");class l extends r.sR{constructor(e){if(super(e),e.type!==s.pX.ELEMENT)throw new Error(`\`${this.constructor.name}\` must be bound to an element.`);this.previousValue=n}render(e,t){return o.Ld}update(e,[t,i]){if(!this.hasChanged(i))return o.Ld;this.host=e.options&&e.options.host,this.element=e.element,this.renderer=t;return this.previousValue===n?this.addRenderer():this.runRenderer(),this.previousValue=Array.isArray(i)?[...i]:i,o.Ld}reconnected(){this.addRenderer()}disconnected(){this.removeRenderer()}addRenderer(){throw new Error("The `addRenderer` method must be implemented.")}runRenderer(){throw new Error("The `runRenderer` method must be implemented.")}removeRenderer(){throw new Error("The `removeRenderer` method must be implemented.")}renderRenderer(e,...t){const i=this.renderer.call(this.host,...t);(0,o.sY)(i,e,{host:this.host})}hasChanged(e){return Array.isArray(e)?!Array.isArray(this.previousValue)||(this.previousValue.length!==e.length||e.some(((e,t)=>e!==this.previousValue[t]))):this.previousValue!==e}}const a=(0,s.XM)(class extends l{addRenderer(){this.element.renderer=(e,t,i)=>{this.renderRenderer(e,i.item,i,t)}}runRenderer(){this.element.requestContentUpdate()}removeRenderer(){this.element.renderer=null}})},39924:(e,t,i)=>{class s extends HTMLElement{static get version(){return"23.3.5"}}customElements.define("vaadin-material-styles",s);var o=i(70620);const r=o.iv`
  :host {
    /* Text colors */
...
`,M=c;(0,o.hC)("",M,{moduleId:"material-menu-overlay"});const F=o.iv`
  :host {
...
`;(0,o.hC)("vaadin-combo-box-overlay",[M,F,H],{moduleId:"material-combo-box-overlay"});const $=o.iv`
  :host {
    display: flex;
    align-items: center;
    box-sizing: border-box;
...
//# sourceMappingURL=7ba0b38d.js.map