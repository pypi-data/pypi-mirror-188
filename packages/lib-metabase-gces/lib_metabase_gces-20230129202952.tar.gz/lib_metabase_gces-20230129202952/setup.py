...
setup_kwargs = {
    'name': 'lib-metabase-gces',
    'version': '20230129202952',
    'description': 'A library that helps developers visualize data made in the GCES course at UnB.',
    ...
    'author': 'DafneM',
    'author_email': 'moretti.dafne@gmail.com',
    'maintainer': 'None',
