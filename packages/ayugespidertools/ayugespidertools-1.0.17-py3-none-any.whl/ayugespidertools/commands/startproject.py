...
"""
# 旧引用 scrapy 的 startproject 主要方法
from os.path import join, exists, abspath
import ayugespidertools
from scrapy.commands.startproject import Command
...
class AyuCommand(Command):
    ...
    def run(self, args, opts):
        ...
        render_templatefile(
            ...
            project_startup_dir=abspath(project_dir), ProjectStartupDir=string_camelcase(abspath(project_dir)),
            project_name=project_name, ProjectName=string_camelcase(project_name))
