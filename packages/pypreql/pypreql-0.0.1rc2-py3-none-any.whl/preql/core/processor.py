...
def graph_to_query(environment: Environment, g: nx.Graph, statement: Select) -> ProcessedQuery:
    ...
    return ProcessedQuery(output_columns=statement.output_components,
                          ctes=inputs, joins=joins, grain=statement.grain, limit=statement.limit, order_by = statement.order_by)
