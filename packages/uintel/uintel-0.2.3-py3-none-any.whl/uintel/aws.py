...
def upload_file_to_S3(local_filepath: str, remote_filepath: str, s3_client: boto3.client = create_aws_client('s3'), bucket: str = "urbanintelligencedevdata", extra_args: dict = None) -> None:
...
def download_file_from_S3(remote_filepath: str, local_filepath: str, s3_client: boto3.client = create_aws_client('s3'), bucket: str = "urbanintelligencedevdata") -> None:
