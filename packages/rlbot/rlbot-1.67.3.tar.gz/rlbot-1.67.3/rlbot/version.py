...
release_notes = {
    '1.67.3': """
    Fixed an issue where VirxEC would ping GooseFairy every month in #framework-dev - VirxEC
    """,
    '1.67.2': """
    Added Season 8+ items - VirxEC
    Added new maps - Darxeal
    Bugfix for standalone bots in the Rust GUI - VirxEC
    """,
    '1.67.1': """
    Implemented fixes for standalone bots. - VirxEC
    """,
    '1.67.0': """
