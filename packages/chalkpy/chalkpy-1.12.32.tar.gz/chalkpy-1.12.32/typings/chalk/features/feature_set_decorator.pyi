...
from tests.client.test_client_dataset import TransactionV2 as __stubgen_tests_client_test__client__dataset_TransactionV2
...
from tests.test_versions import VChild as __stubgen_tests_test__versions_VChild
from tests.test_versions import VChild1 as __stubgen_tests_test__versions_VChild1
from tests.test_versions import VParent as __stubgen_tests_test__versions_VParent
...
class FunkyMetaclass(FeaturesMeta):
    @property
    def id(self) -> Type[str]: ...

    @property
    def trumpet(self) -> Type[str]: ...

    @property
    def saxophone(self) -> Type[str]: ...

    @property
    def trumpet_v1(self) -> Type[str]: ...

    @property
    def trumpet_v2(self) -> Type[str]: ...

    @property
    def saxophone_v1(self) -> Type[str]: ...

    @property
    def saxophone_v2(self) -> Type[str]: ...

    @property
    def saxophone_v3(self) -> Type[str]: ...

    @property
    def __chalk_observed_at__(self) -> Type[__stubgen_datetime_datetime]: ...

class Funky(Features, metaclass=FunkyMetaclass):
    def __init__(
        self,
        id: str = ...,
        trumpet: str = ...,
        ...
        self.trumpet_v1: str
        self.trumpet_v2: str
        self.saxophone_v1: str
        self.saxophone_v2: str
        self.saxophone_v3: str
        self.__chalk_observed_at__: __stubgen_datetime_datetime

class FunkyProtocol(Protocol):
    id: str
    trumpet: str
    saxophone: str
    trumpet_v1: str
...
class VChild1Metaclass(FeaturesMeta):
    @property
    def id(self) -> Type[str]: ...

    @property
    def evolving(self) -> Type[int]: ...

    @property
    def evolving_v1(self) -> Type[int]: ...

    @property
    def evolving_v2(self) -> Type[int]: ...

    @property
    def __chalk_observed_at__(self) -> Type[__stubgen_datetime_datetime]: ...

class VChild1(Features, metaclass=VChild1Metaclass):
    def __init__(
        self,
        id: str = ...,
        evolving: int = ...,
        ...
        self.id: str
        self.evolving: int
        self.evolving_v1: int
        self.evolving_v2: int
        self.__chalk_observed_at__: __stubgen_datetime_datetime

class VChild1Protocol(Protocol):
    id: str
    evolving: int
    evolving_v1: int
    evolving_v2: int

class VChildMetaclass(FeaturesMeta):
    @property
    def id(self) -> Type[str]: ...
...
class VChild(Features, metaclass=VChildMetaclass):
    def __init__(
        self,
        id: str = ...,
        evolving: int = ...,
...
class VParentMetaclass(FeaturesMeta):
    @property
    def id(self) -> Type[str]: ...

    @property
    def child(self) -> Type[__stubgen_tests_test__versions_VChild]: ...

    @property
    def child1(self) -> Type[__stubgen_tests_test__versions_VChild1]: ...

    @property
    def __chalk_observed_at__(self) -> Type[__stubgen_datetime_datetime]: ...

class VParent(Features, metaclass=VParentMetaclass):
    def __init__(
        self,
        id: str = ...,
        child: __stubgen_tests_test__versions_VChild = ...,
        child1: __stubgen_tests_test__versions_VChild1 = ...,
        __chalk_observed_at__: __stubgen_datetime_datetime = ...,
    ):
        self.id: str
        self.child: __stubgen_tests_test__versions_VChild
        self.child1: __stubgen_tests_test__versions_VChild1
        self.__chalk_observed_at__: __stubgen_datetime_datetime

class VParentProtocol(Protocol):
    id: str
    child: __stubgen_tests_test__versions_VChild
    child1: __stubgen_tests_test__versions_VChild1
...
class TransactionV2Metaclass(FeaturesMeta):
    @property
    def id(self) -> Type[int]: ...
...
class TransactionV2(Features, metaclass=TransactionV2Metaclass):
    def __init__(
        self,
        id: int = ...,
        user_id: int = ...,
...
class TransactionV2Protocol(Protocol):
    id: int
    user_id: int
    amount: float
    ts: __stubgen_datetime_datetime
...
class TransactionPointerMetaclass(FeaturesMeta):
    ...
    @property
    def transaction(self) -> Type[__stubgen_tests_client_test__client__dataset_TransactionV2]: ...
...
class TransactionPointer(Features, metaclass=TransactionPointerMetaclass):
    def __init__(
        ...
        id: int = ...,
        transaction_id: int = ...,
        transaction: __stubgen_tests_client_test__client__dataset_TransactionV2 = ...,
        __chalk_observed_at__: __stubgen_datetime_datetime = ...,
    ):
        self.id: int
        self.transaction_id: int
        self.transaction: __stubgen_tests_client_test__client__dataset_TransactionV2
        self.__chalk_observed_at__: __stubgen_datetime_datetime
...
class VGrandParentMetaclass(FeaturesMeta):
    @property
    def id(self) -> Type[str]: ...

    @property
    def parent(self) -> Type[__stubgen_tests_test__versions_VParent]: ...

    @property
    def __chalk_observed_at__(self) -> Type[__stubgen_datetime_datetime]: ...

class VGrandParent(Features, metaclass=VGrandParentMetaclass):
    def __init__(
        self,
        id: str = ...,
        parent: __stubgen_tests_test__versions_VParent = ...,
        __chalk_observed_at__: __stubgen_datetime_datetime = ...,
    ):
        self.id: str
        self.parent: __stubgen_tests_test__versions_VParent
        self.__chalk_observed_at__: __stubgen_datetime_datetime

class VGrandParentProtocol(Protocol):
    id: str
    parent: __stubgen_tests_test__versions_VParent
...
@overload
def features(item: Type[FunkyProtocol]) -> Type[Funky]: ...
...
@overload
def features(item: Type[VChild1Protocol]) -> Type[VChild1]: ...

@overload
def features(item: Type[VChildProtocol]) -> Type[VChild]: ...
...
@overload
def features(item: Type[VParentProtocol]) -> Type[VParent]: ...

@overload
def features(item: Type[UserProfileProtocol]) -> Type[UserProfile]: ...

@overload
def features(item: Type[TransactionV2Protocol]) -> Type[TransactionV2]: ...
...
@overload
def features(item: Type[VGrandParentProtocol]) -> Type[VGrandParent]: ...
...
class __stubgen__features_proto(Protocol):
    ...
    @overload
    def __call__(self, item: Type[FunkyProtocol]) -> Type[Funky]: ...
    ...
    @overload
    def __call__(self, item: Type[VChild1Protocol]) -> Type[VChild1]: ...

    @overload
    def __call__(self, item: Type[VChildProtocol]) -> Type[VChild]: ...
    ...
    @overload
    def __call__(self, item: Type[VParentProtocol]) -> Type[VParent]: ...

    @overload
    def __call__(self, item: Type[UserProfileProtocol]) -> Type[UserProfile]: ...

    @overload
    def __call__(self, item: Type[TransactionV2Protocol]) -> Type[TransactionV2]: ...
    ...
    @overload
    def __call__(self, item: Type[VGrandParentProtocol]) -> Type[VGrandParent]: ...
