...
<!-- surcharge pour affecter un niveau de titre pour les références bibliographiques d'ouvrage recensé -->
    <xsl:when test="$currentElementName='text:p' and (@text:style-name='TEI_5f_reviewed_5f_reference' or //style:style[@style:name=$currentStyle]/@style:parent-style-name='TEI_5f_reviewed_5f_reference')">
        <xsl:element name="text:h">
            <xsl:copy-of select="@*"/>
...
<!-- ajout d'un @outline-level sur le titre de section biblio (Métopes) /!\ -->
    ...
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_floatingText_5f_start'"><startFloatingText/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_floatingText_5f_end'"><endFloatingText/></xsl:when>
    <!-- début et fin de citations -->
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_quote_5f_start'"><startCit/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_quote_5f_end'"><endCit/></xsl:when>
    <!-- début et fin de code -->
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_code_5f_start'"><startCode/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_code_5f_end'"><endCode/></xsl:when>
    <!-- début et fin de figure -->
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_figure_5f_start'"><startFigure/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_figure_5f_end'"><endFigure/></xsl:when>
