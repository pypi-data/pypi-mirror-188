...
class LVMSimpleForm(NetBoxModelForm):
    ...
    def save(self, *args, **kwargs):
        ...
        partition = Partition(drive=instance, device=instance.device_name, size=self.size, type="Linux LVM")
        partition.save()
        vg = VolumeGroup(vg_name=self.vg_name)
        PhysicalVolume(partition=partition, pv_name=instance.device_name, vg=vg)
