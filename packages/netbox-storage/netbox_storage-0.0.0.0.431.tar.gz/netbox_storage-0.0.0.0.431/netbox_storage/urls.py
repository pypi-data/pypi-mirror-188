...
from netbox_storage.views import (
    ...
    LinuxVolumeView,
    LinuxVolumeDeleteView, VolumeGroupPhysicalVolumeListView,
)
...
urlpatterns = [
    ...
    path("volumegroup/<int:pk>/physicalvolume/", VolumeGroupPhysicalVolumeListView.as_view(), name="vg_physicalvolumes"),
    #
    # LogicalVolume urls
    #
