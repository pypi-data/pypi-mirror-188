...
class LVMModel:
    def __init__(self, lv_name, path, fs, vg_name, pv_list=None, partition_list=None, drive_list=None):
...
class RelatedDrives(PluginTemplateExtension):
    ...
    def full_width_page(self):
        ...
        for lv in lvs:
            ...
            lvm_list.append(LVMModel(lv.lv_name, lv.path, lv.fs, lv.vg.vg_name))
