...
from DrissionPage import MixPage, WebPage, ChromiumPage
from DrissionPage.chromium_driver import ChromiumDriver
...
class BaseListener(object):
    ...
    def to_tab(self,
        ...
        self._tab = ChromiumDriver(self.tab_id, "page", self._browser)
        self._tab.start()
    ...
    def _set_browser(self, browser=None):
        ...
        :return: None
        """
        if isinstance(browser, (WebPage, ChromiumPage)):
            browser = browser.address

        elif isinstance(browser, MixPage):
