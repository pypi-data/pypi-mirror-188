...
class ArthurModel(ArthurBaseJsonDataclass):
    ...
    def create_metric(self, name: str, query: Dict[str, Any], is_data_drift: bool = False) -> str:
        ...
        see https://docs.arthur.ai/user-guide/walkthroughs/alerts.html#create-metrics
    ...
    def create_alert_rule(self,
        ...
        For a guide to configuring alerts, see https://docs.arthur.ai/user-guide/walkthroughs/alerts.html
