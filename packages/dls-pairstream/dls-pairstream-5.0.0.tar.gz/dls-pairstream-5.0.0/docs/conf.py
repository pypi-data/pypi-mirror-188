...
import dls_pairstream_lib

# -- General configuration ------------------------------------------------

# General information about the project.
project = "dls-pairstream"

# The full version, including alpha/beta/rc tags.
release = dls_pairstream_lib.__version__
...
html_theme_options = dict(
    ...
    gitlab_url="https://gitlab.diamond.ac.uk/kbp43231/dls-pairstream",
    icon_links=[],
...
ultimate_replacements = {
    "$" + "{repository_name}": "dls-pairstream",
    "$" + "{package_name}": "dls_pairstream_lib",
...
# dae_devops_fingerprint fc2f369d9e82618e08c21d033d74fd22
