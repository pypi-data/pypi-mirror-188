...
setup(
    ...
    packages = ['Relatorio_Ensalamento','Relatorio_Ensalamento.Sugestao'],
    description = 'Conversor utilizado para a geração do relatorio ensalamento',
    long_description = 'Comandos utilizados, gerarExcel(caminho_carga_horaria,caminho_capacidade,caminho_xml)',
    license = 'MIT',
