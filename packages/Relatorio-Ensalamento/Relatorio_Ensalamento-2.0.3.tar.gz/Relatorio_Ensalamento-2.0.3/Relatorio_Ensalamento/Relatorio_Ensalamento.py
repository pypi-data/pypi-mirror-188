...
def main(arquivo_carga_horaria, arquivo_capacidade, arquivo_xml, file_name):
    ...
    utc_now = pytz.utc.localize(datetime.datetime.utcnow())
    dt_now = utc_now.astimezone(pytz.timezone("America/Sao_Paulo"))
    f = open(f"{str(dt_now.strftime('%y-%m-%d %H-%M'))}.txt", "w+", encoding="utf8")
...
if __name__ == '__main__':
    arquivo_carga_horaria = "C:/Users/m.rosa1/Downloads/relatorio_ch_turma_disc_2023-01-26_geral_13h.xlsx"
    arquivo_capacidade = "C:/Users/m.rosa1/Downloads/08 Capacidade dos Espa̤os de Ensino PUCPR_20221128.xlsx"
    arquivo_xml = "C:/Users/m.rosa1/Downloads/XML ASC unificado_20230125.xml"
    file_name='C:/Users/m.rosa1/Downloads/matheus_teste.xlsx'

    gerarExcel(arquivo_carga_horaria,arquivo_capacidade,arquivo_xml,file_name)
