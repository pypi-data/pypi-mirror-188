...
class WebMapService111(object):
    ...
    def __build_getmap_request(self, layers=None, styles=None, srs=None, bbox=None, format_output=None, size=None,
                               time=None, transparent=False, bgcolor=None, exceptions=None, **kwargs):
    ...
    def getmap(self, layers=None, styles=None, srs=None, bbox=None, format_output=None, size=None, time=None,
               transparent=False, bgcolor='#FFFFFF', exceptions='application/vnd.ogc.se_xml', method='Get',
               timeout=None, **kwargs):
        try:
...
def web_map_service(url, version='1.1.1', xml=None, username=None, password=None, parse_remote_metadata=False,
    ...
    """
    Get a WebMapService111 (OWSLib) instance for the given url and version.
    :param url: The url of the WMS service.
    :param version: The version of the WMS service.
    :param xml: The xml of the WMS service.
    :param username: The username for authentication.
    :param password: The password for authentication.
    :param parse_remote_metadata: Whether to parse remote metadata.
    :param timeout: The timeout for the request.
    :param headers: The headers for the request.
    :param auth: The authentication information.
    :return: The WebMapService111 instance.
    """
    if auth:
        if username:
            auth.username = username
