...
def init():
    ...
    utils.console.print("[yellow]You are using an outdated pip package (pynecone-io)[/yellow]")
    utils.console.print("[yellow]Since v0.1.14 Pynecone is now available as [green]pip install pynecone[/green]. This package is now deprecated and will stop receiving updates.[/yellow]")
