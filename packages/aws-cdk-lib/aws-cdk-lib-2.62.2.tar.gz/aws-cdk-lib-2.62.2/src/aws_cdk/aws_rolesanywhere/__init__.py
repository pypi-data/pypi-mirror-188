...
class CfnCRL(
    ...
    def __init__(
        ...
        *,
        ...
        :param crl_data: The revocation record for a certificate, following the x509 v3 standard.
        :param enabled: Indicates whether the certificate revocation list (CRL) is enabled.
        :param name: The name of the certificate revocation list (CRL).
        :param tags: A list of tags to attach to the CRL.
    ...
    *Required permissions:* ``rolesanywhere:CreateProfile`` .
    ...
    def __init__(
        ...
        *,
        ...
        :param tags: A list of tags to attach to the profile.
        '''
        if __debug__:
    ...
    class SourceProperty:
        def __init__(
            ...
            *,
            ...
            :param source_type: The type of the trust anchor.
