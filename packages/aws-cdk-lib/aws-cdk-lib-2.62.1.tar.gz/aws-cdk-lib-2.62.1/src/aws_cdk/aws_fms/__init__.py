...
class CfnPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param policy_description: ``AWS::FMS::Policy.PolicyDescription``.
        ...
        :param resource_set_ids: ``AWS::FMS::Policy.ResourceSetIds``.
    ...
    class NetworkFirewallPolicyProperty:
        def __init__(self, *, firewall_deployment_model: builtins.str) -> None:
            ...
            :param firewall_deployment_model: Defines the deployment model to use for the firewall policy. To use a distributed model, set `PolicyOption <https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html>`_ to ``NULL`` .
        ...
        def firewall_deployment_model(self) -> builtins.str:
            ...
            To use a distributed model, set `PolicyOption <https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html>`_ to ``NULL`` .
    ...
    class SecurityServicePolicyDataProperty:
        ...
        def managed_service_data(self) -> typing.Optional[builtins.str]:
            ...
            To use the centralized deployment model, you must set `PolicyOption <https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html>`_ to ``CENTRALIZED`` .
            ...
            With automatic Availbility Zone configuration, Firewall Manager chooses which Availability Zones to create the endpoints in. To use the distributed deployment model, you must set `PolicyOption <https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html>`_ to ``NULL`` .
            ...
            To use the distributed deployment model, you must set `PolicyOption <https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_PolicyOption.html>`_ to ``NULL`` .
