...
class CfnDomain(
    ...
    def __init__(
        ...
        *,
        ...
        cluster_config: typing.Optional[typing.Union[typing.Union["CfnDomain.ClusterConfigProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
