...
class CfnExecutionPlan(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        capacity_units: typing.Optional[typing.Union[typing.Union["CfnExecutionPlan.CapacityUnitsConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
        ...
        :param name: ``AWS::KendraRanking::ExecutionPlan.Name``.
        :param capacity_units: ``AWS::KendraRanking::ExecutionPlan.CapacityUnits``.
        :param description: ``AWS::KendraRanking::ExecutionPlan.Description``.
        :param tags: ``AWS::KendraRanking::ExecutionPlan.Tags``.
        '''
        if __debug__:
    ...
    def capacity_units(
        self,
    ) -> typing.Optional[typing.Union["CfnExecutionPlan.CapacityUnitsConfigurationProperty", _IResolvable_da3f097b]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnExecutionPlan.CapacityUnitsConfigurationProperty", _IResolvable_da3f097b]], jsii.get(self, "capacityUnits"))

    @capacity_units.setter
    def capacity_units(
        self,
        value: typing.Optional[typing.Union["CfnExecutionPlan.CapacityUnitsConfigurationProperty", _IResolvable_da3f097b]],
    ) -> None:
        if __debug__:
    ...
    class CapacityUnitsConfigurationProperty:
        def __init__(self, *, rescore_capacity_units: jsii.Number) -> None:
            '''
            :param rescore_capacity_units: ``CfnExecutionPlan.CapacityUnitsConfigurationProperty.RescoreCapacityUnits``.
...
class CfnExecutionPlanProps:
    ...
    def capacity_units(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnExecutionPlan.CapacityUnitsConfigurationProperty, _IResolvable_da3f097b]], result)
