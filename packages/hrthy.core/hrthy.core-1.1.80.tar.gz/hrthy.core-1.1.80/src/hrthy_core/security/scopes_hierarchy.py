from hrthy_core.security.scopes import (
    ...
    SCOPE_PIPELINE_CANDIDATE_MY_LIST, SCOPE_PIPELINE_CANDIDATE_MY_START, SCOPE_PIPELINE_CANDIDATE_MY_STOP,
    SCOPE_PIPELINE_CANDIDATE_START,
...
HIERARCHY_SCOPES = {
    ...
    SCOPE_PIPELINE_CANDIDATE_START: {
        'type': ScopeType.GLOBAL,
        'includes': [SCOPE_PIPELINE_CANDIDATE_MY_START],
        'depends': {ConditionType.AND: [SCOPE_PIPELINE_CANDIDATE_LIST]},
        'visible': [SCOPE_ROLE_MY_ASSIGN_GLOBAL]
    },
    SCOPE_PIPELINE_CANDIDATE_STOP: {
        'type': ScopeType.GLOBAL,
        'includes': [SCOPE_PIPELINE_CANDIDATE_MY_STOP],
        'depends': {ConditionType.AND: [SCOPE_PIPELINE_CANDIDATE_LIST]},
        'visible': [SCOPE_ROLE_MY_ASSIGN_GLOBAL]
    },
    SCOPE_PIPELINE_CANDIDATE_MY_START: {
        'type': ScopeType.COMPANY,
        'includes': [],
        'depends': {ConditionType.AND: [SCOPE_PIPELINE_CANDIDATE_MY_LIST]},
        'visible': True
    },
    SCOPE_PIPELINE_CANDIDATE_MY_STOP: {
        'type': ScopeType.COMPANY,
        'includes': [],
        'depends': {ConditionType.AND: [SCOPE_PIPELINE_CANDIDATE_MY_LIST, SCOPE_PIPELINE_CANDIDATE_MY_START]},
        'visible': True
    },
    # endregion
