...
# Permissions to start and stop candidates on a pipeline
SCOPE_PIPELINE_CANDIDATE_START = 'pip.can.st'  # SuperAdmin
SCOPE_PIPELINE_CANDIDATE_STOP = 'pip.can.sp'  # SuperAdmin
SCOPE_PIPELINE_CANDIDATE_MY_START = 'pip.can.my.st'  # Admin, User
SCOPE_PIPELINE_CANDIDATE_MY_STOP = 'pip.can.my.sp'  # Admin, User
# endregion
