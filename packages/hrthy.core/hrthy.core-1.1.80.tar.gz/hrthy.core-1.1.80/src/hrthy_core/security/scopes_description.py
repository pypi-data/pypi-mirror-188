from hrthy_core.security.scopes import (
    ...
    SCOPE_PIPELINE_CANDIDATE_MY_START, SCOPE_PIPELINE_CANDIDATE_MY_STOP, SCOPE_PIPELINE_CANDIDATE_START,
    SCOPE_PIPELINE_CANDIDATE_STOP,
...
DESCRIPTIONS_SCOPES = {
    ...
    # region PIPELINE - CANDIDATE - START/STOP
    SCOPE_PIPELINE_CANDIDATE_START: 'User can start the pipeline for a candidate in other companies',
    SCOPE_PIPELINE_CANDIDATE_STOP: 'User can stop the pipeline for a candidate in other companies',
    SCOPE_PIPELINE_CANDIDATE_MY_START: 'User can start the pipeline for a candidate in its company',
    SCOPE_PIPELINE_CANDIDATE_MY_STOP: 'User can stop the pipeline for a candidate in its company',
    # endregion
