...
class EntailmentsRequest(google.protobuf.message.Message):
    ...
    language: builtins.str
    @property
    def segments(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, arg_services.mining.v1.adu_pb2.Segment]: ...
    @property
    def extras(self) -> google.protobuf.struct_pb2.Struct:
        """Implementation-specific information can be encoded here"""
    def __init__(
        ...
        *,
        language: builtins.str = ...,
        segments: collections.abc.Mapping[builtins.str, arg_services.mining.v1.adu_pb2.Segment] | None = ...,
        extras: google.protobuf.struct_pb2.Struct | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["extras", b"extras"]) -> builtins.bool: ...
