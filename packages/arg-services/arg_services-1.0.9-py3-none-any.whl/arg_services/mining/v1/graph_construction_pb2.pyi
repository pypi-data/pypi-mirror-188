...
class GraphConstructionRequest(google.protobuf.message.Message):
    ...
    class AdusEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: builtins.str = ...,
            value: arg_services.mining.v1.adu_pb2.Segment | None = ...,
        ) -> None: ...
    ...
    @property
    def adus(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, arg_services.mining.v1.adu_pb2.Segment]: ...
    ...
    def __init__(
        ...
        *,
        language: builtins.str = ...,
        adus: collections.abc.Mapping[builtins.str, arg_services.mining.v1.adu_pb2.Segment] | None = ...,
        major_claim_id: builtins.str = ...,
        entailments: collections.abc.Iterable[arg_services.mining.v1.entailment_pb2.Entailment] | None = ...,
