...
from tecton import types as tecton_types
...
def get_request_schema_from_spark_schema(spark_schema_proto: spark_schema_pb2.SparkSchema) -> List[tecton_types.Field]:
    ...
    for c_and_t in columns_and_types:
        ...
        request_schema.append(tecton_types.Field(name, data_type))
