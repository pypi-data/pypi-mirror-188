...
from sktmls.utils import LogicProcessor, LogicCaller
import imp
import sys
...
handler_code = LogicCaller(
    handler_path="https://github.com/sktaiflow/dag-advanced_analytics/blob/develop/mls_handler/simple_example/handler_example.py"
)
