...
Droid Client:
    ...
    async def create_bot(
            ...
            price: np.float32,
            margin: Optional[np.float16],
            fraction: Optional[bool],
            multiplier_1: Optional[np.float16],
            multiplier_2: Optional[np.float16],
            r: Optional[np.float32],
            q: Optional[np.float32],
        ) -> Dict[str, NDArray]:
        """
        Create a single bot.
    ...
    async def create_bots(
            ...
            margin: Optional[NDArray[np.float16]],
            fraction: Optional[NDArray[bool]],
            multiplier_1: Optional[NDArray[np.float16]],
            multiplier_2: Optional[NDArray[np.float16]],
            r: Optional[np.float32],
            q: Optional[np.float32],
        ) -> Dict[str, NDArray]:
        """
