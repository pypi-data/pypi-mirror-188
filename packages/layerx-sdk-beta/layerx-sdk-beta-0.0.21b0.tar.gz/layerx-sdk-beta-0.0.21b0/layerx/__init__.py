...
class LayerxClient:
    ...
    create annotation studio project using query, filter and collections
    """
    def create_annotation_project_from_datalake(self, project_name: str, datalake_query: str, datalake_filter, object_type: int, fps: int = 0):
        print(f'create project using query, filter and collections - project name: {project_name}, ')
    ...
    def download_project_annotations(self, project_id: str, model_id: str):
        # init dataset client
        _dataset_client = dataset.DatasetClient(self.encoded_key_secret, self.layerx_url)
