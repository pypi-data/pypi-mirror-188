...
from yutils.tools.numpy_tools import is_matrix, normalize_array, NPConstants
from yutils.ml.base.ml_base import MLObject


class FeatureNormalizer(MLObject):
    _INPUT_TYPES = dict(original_info=None)
    ...
    def __init__(self, info):
        ...
        global np
        np = import_numpy()
        self._INPUT_TYPES['original_info'] = NPConstants().TWO_D_NP_ARRAY_INTS_FLOATS_TYPE
