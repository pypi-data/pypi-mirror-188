...
setup_kwargs = {
    'name': 'trabalho-individual-2022-2-adrian-160000572',
    'version': '0.1.2',
    'description': 'Lib to manage metadata of databases to be consumed by data analysis tools',
