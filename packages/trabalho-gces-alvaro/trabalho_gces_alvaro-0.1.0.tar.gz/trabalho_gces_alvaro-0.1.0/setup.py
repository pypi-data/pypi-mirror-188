...
setup_kwargs = {
    'name': 'trabalho-gces-alvaro',
    'version': '0.1.0',
    'description': 'Uma biblioteca python para executar pipelines de dados de forma customizável em bancos de dados',
    ...
    'author_email': 'alvaro.leles@hotmail.com',
    'maintainer': 'None',
