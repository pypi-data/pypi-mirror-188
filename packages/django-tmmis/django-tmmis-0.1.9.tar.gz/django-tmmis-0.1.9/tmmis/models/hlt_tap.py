...
class HltTap(BaseModel):
    ...
    stat_cure_result_id = models.IntegerField(db_column='rf_kl_StatCureResultID')
    ...
    med_care_type_id = models.IntegerField(db_column='rf_kl_MedCareTypeID')
    ...
    dd_service_id = models.IntegerField(db_column='rf_kl_DDServiceID')
