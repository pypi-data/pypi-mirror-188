...
class OmsServiceMedical(BaseModel):
    ...
    med_care_type = models.ForeignKey('oms_kl_med_care_type.py', db_column='rf_kl_MedCareTypeID', **FK_DEFAULT)
    ...
    department_profile = models.ForeignKey('OmsKlDepartmentProfile', db_column='rf_kl_DepartmentProfileID', **FK_DEFAULT)
