...
Notes:
    ...
    cd ~/code/vtool_ibeis_ext/docs
    sphinx-apidoc -f -o ~/code/vtool_ibeis_ext/docs/source ~/code/vtool_ibeis_ext/vtool_ibeis_ext --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/vtool_ibeis_ext/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/vtool_ibeis_ext/versions/
"""
#
...
# html_logo = '.static/vtool_ibeis_ext.svg'
# html_favicon = '.static/vtool_ibeis_ext.ico'
...
htmlhelp_basename = 'vtool_ibeis_extdoc'
...
latex_documents = [
    (master_doc, 'vtool_ibeis_ext.tex', 'vtool_ibeis_ext Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'vtool_ibeis_ext', 'vtool_ibeis_ext Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'vtool_ibeis_ext', 'vtool_ibeis_ext Documentation',
     author, 'vtool_ibeis_ext', 'One line description of project.',
     'Miscellaneous'),
]
