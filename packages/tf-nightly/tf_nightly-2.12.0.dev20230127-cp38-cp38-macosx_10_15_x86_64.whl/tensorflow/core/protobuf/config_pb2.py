...
_GPUOPTIONS_EXPERIMENTAL_VIRTUALDEVICES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_ordinal', full_name='tensorflow.GPUOptions.Experimental.VirtualDevices.device_ordinal', index=2,
...
_GPUOPTIONS_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gpu_host_mem_limit_in_mb', full_name='tensorflow.GPUOptions.Experimental.gpu_host_mem_limit_in_mb', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gpu_host_mem_disallow_growth', full_name='tensorflow.GPUOptions.Experimental.gpu_host_mem_disallow_growth', index=12,
...
_CONFIGPROTO_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disable_optimize_for_static_graph', full_name='tensorflow.ConfigProto.Experimental.disable_optimize_for_static_graph', index=20,
...
_CONFIGPROTO_EXPERIMENTAL.fields_by_name['coordination_config'].message_type = tensorflow_dot_tsl_dot_protobuf_dot_coordination__config__pb2._COORDINATIONSERVICECONFIG
...
_CONFIGPROTO.fields_by_name['rpc_options'].message_type = tensorflow_dot_tsl_dot_protobuf_dot_rpc__options__pb2._RPCOPTIONS
