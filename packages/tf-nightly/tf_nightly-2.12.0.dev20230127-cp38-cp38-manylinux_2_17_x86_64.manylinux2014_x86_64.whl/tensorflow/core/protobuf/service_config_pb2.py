...
_DISPATCHERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='worker_timeout_ms', full_name='tensorflow.data.experimental.DispatcherConfig.worker_timeout_ms', index=9,
