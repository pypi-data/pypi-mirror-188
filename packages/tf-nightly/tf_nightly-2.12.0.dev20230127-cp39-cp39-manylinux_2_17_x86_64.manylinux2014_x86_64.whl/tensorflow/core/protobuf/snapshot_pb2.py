...
_DISTRIBUTEDSNAPSHOTMETADATA = _descriptor.Descriptor(
  name='DistributedSnapshotMetadata',
  full_name='tensorflow.data.experimental.DistributedSnapshotMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='element_spec', full_name='tensorflow.data.experimental.DistributedSnapshotMetadata.element_spec', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compression', full_name='tensorflow.data.experimental.DistributedSnapshotMetadata.compression', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['DistributedSnapshotMetadata'] = _DISTRIBUTEDSNAPSHOTMETADATA
...
DistributedSnapshotMetadata = _reflection.GeneratedProtocolMessageType('DistributedSnapshotMetadata', (_message.Message,), {
  'DESCRIPTOR' : _DISTRIBUTEDSNAPSHOTMETADATA,
  '__module__' : 'tensorflow.core.protobuf.snapshot_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.data.experimental.DistributedSnapshotMetadata)
  })
_sym_db.RegisterMessage(DistributedSnapshotMetadata)
