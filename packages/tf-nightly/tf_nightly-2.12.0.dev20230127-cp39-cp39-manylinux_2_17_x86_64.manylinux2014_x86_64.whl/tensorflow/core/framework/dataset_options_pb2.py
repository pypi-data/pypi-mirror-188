...
_OPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='symbolic_checkpoint', full_name='tensorflow.data.Options.symbolic_checkpoint', index=7,
  ...
  oneofs=[
    ...
    _descriptor.OneofDescriptor(
      ...
      index=2, containing_type=None, fields=[]),
    _descriptor.OneofDescriptor(
      name='optional_symbolic_checkpoint', full_name='tensorflow.data.Options.optional_symbolic_checkpoint',
      index=3, containing_type=None, fields=[]),
  ],
...
_OPTIONS.oneofs_by_name['optional_symbolic_checkpoint'].fields.append(
  _OPTIONS.fields_by_name['symbolic_checkpoint'])
_OPTIONS.fields_by_name['symbolic_checkpoint'].containing_oneof = _OPTIONS.oneofs_by_name['optional_symbolic_checkpoint']
