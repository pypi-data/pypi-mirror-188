...
class Options :
 ...
 private:
  ...
  union OptionalSymbolicCheckpointUnion {
    OptionalSymbolicCheckpointUnion() {}
...
inline void Options::set_has_symbolic_checkpoint() {
  _oneof_case_[3] = kSymbolicCheckpoint;
}
inline void Options::clear_symbolic_checkpoint() {
  if (has_symbolic_checkpoint()) {
    optional_symbolic_checkpoint_.symbolic_checkpoint_ = false;
...
inline bool Options::symbolic_checkpoint() const {
  ...
  if (has_symbolic_checkpoint()) {
    return optional_symbolic_checkpoint_.symbolic_checkpoint_;
  }
  return false;
}
inline void Options::set_symbolic_checkpoint(bool value) {
  ...
  optional_symbolic_checkpoint_.symbolic_checkpoint_ = value;
...
inline void Options::clear_has_optional_symbolic_checkpoint() {
  _oneof_case_[3] = OPTIONAL_SYMBOLIC_CHECKPOINT_NOT_SET;
}
...
inline Options::OptionalSymbolicCheckpointCase Options::optional_symbolic_checkpoint_case() const {
  return Options::OptionalSymbolicCheckpointCase(_oneof_case_[3]);
}
#ifdef __GNUC__
