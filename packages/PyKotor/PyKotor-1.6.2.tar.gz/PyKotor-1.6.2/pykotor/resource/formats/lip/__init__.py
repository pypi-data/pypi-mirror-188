from pykotor.resource.formats.lip.lip_data import LIP, LIPShape, LIPKeyFrame
...
from pykotor.resource.formats.lip.lip_auto import read_lip, write_lip, detect_lip
