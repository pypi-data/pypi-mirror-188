...
class RenderObject:
    ...
    def set_position(self, x: float, y: float, z: float) -> None:
        if math.isclose(self._position.x, x, rel_tol=1e-03) and math.isclose(self._position.y, y, rel_tol=1e-03) and math.isclose(self._position.z, z, rel_tol=1e-03):
            return
    ...
    def set_rotation(self, x: float, y: float, z: float) -> None:
        if math.isclose(self._rotation.x, x, rel_tol=1e-03) and math.isclose(self._rotation.y, y, rel_tol=1e-03) and math.isclose(self._rotation.z, z, rel_tol=1e-03):
            return
