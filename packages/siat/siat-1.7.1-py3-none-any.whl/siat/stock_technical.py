...
def stock_MACD(ticker,start,end, \
    ...
    try:
        ...
        print("  #Error(get_MACD): lack of necessary module - ta-lib")
    ...
    start1=date_adjust(start,adjust=-max_days * 2)
    ...
    if graph in ['MA','ALL']:
        ...
        x_label="数据来源：sina/yahoo/stooq/fred，"+str(today)
        axhline_value=0
        axhline_label=''
