...
Welcome to `pepsis-pidl` contributor's guide.
...
If you experience bugs or general issues with `pepsis-pidl`, please have a look
...
You can help improve `pepsis-pidl` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pepsis-pidl` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pepsis-pidl`'s files. While this mechanism can
...
```
conda create -n pepsis-pidl python=3 six virtualenv pytest pytest-cov
conda activate pepsis-pidl
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pepsis-pidl.git
   cd pepsis-pidl
   ```
...
5. Install [pre-commit]:
   ...
   `pepsis-pidl` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pepsis-pidl
[issue tracker]: https://github.com/<USERNAME>/pepsis-pidl/issues
