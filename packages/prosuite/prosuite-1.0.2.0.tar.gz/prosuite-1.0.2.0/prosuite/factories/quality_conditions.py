...
class Conditions:
    ...
    def qa_min_area_0(cls, polygon_class: BaseDataset, limit: float) -> Condition:
        """
        Finds all polygons in 'polygonClass' with areas smaller than 'limit'
        """
    ...
    def qa_min_area_1(cls, polygon_class: BaseDataset, limit: float, per_part: bool) -> Condition:
        """
        Finds all parts in 'polygonClass' with areas smaller than 'limit'. Parts are defined by perPart
        """
