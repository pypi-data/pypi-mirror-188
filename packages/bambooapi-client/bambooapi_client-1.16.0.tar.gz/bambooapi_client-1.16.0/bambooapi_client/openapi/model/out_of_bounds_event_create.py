...
class OutOfBoundsEventCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_id, time, device_name, variable, value, min, max, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_id, time, device_name, variable, value, min, max, *args, **kwargs):  # noqa: E501
        """OutOfBoundsEventCreate - a model defined in OpenAPI
