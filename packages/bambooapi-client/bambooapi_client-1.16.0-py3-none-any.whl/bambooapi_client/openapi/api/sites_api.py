...
class SitesApi(object):
    ...
    def read_device_activations(
        ...
        **kwargs
        ...
        Return the scheduled or active activation at the given `end_time`.  If there is no active activation, return an empty response.  Returns HTTP400 if the device is not controllable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
