            ...
            try:
                ...
                if isinstance(message, InboundMessage):
                    ...
                    if return_code in [SOLCLIENT_OK, SOLCLIENT_NOT_FOUND]:
                        ...
                        self.adapter.warning(last_error_info(return_code, "receive_async")[
                                                 'error_info_contents'])
        ...
        try:
            ...
            if isinstance(message, InboundMessage):
                ...
                if return_code == SOLCLIENT_NOT_FOUND:
                    return message, None
                raise PubSubPlusClientError(last_error_info(return_code, "receive_message")[
                                                'error_info_contents'])  # pragma: no cover # Due to core error scenarios
            else:
