...
"""Property constant defining the key for configuring the IPv4 or IPv6 address or host name of the 
  PubSub+ event broker to connect to. 
...
"""Property constant defining the key for configuring connection retries. 
  ...
  This property dictates how many times to try to connect to the PubSub+ broker 
  (or list of PubSub+ broker) during connection setup.
...
"""Property constant defining the key for configuring reconnection attempts after an active session
  ...
  This property dictates how many times to attempt to reconnect to the PubSub+ event broker
  (or list of PubSub+ event brokers) after a connected``MessagingService`` goes down. 
