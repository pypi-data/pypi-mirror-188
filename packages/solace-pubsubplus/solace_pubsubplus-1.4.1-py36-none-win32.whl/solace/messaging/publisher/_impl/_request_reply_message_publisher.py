...
class _RequestReplyMessagePublisher(_MessagePublisher, RequestReplyMessagePublisher):
    ...
    def _delivery_mode(self) -> str:
        return SOLCLIENT_DELIVERY_MODE_DIRECT  # TODO: implementation need to be added
    ...
    def publish(self, request_message: 'OutboundMessage',
        ...
        try:
            ...
            raise IllegalStateError(UNABLE_TO_PUBLISH_MESSAGE_PUBLISHER_TERMINATED) from e
    ...
    def _internal_publish_await_response(self, request_message: 'OutboundMessage', request_destination: Topic,
        ...
        try:
            ...
            publish_request_response_message = super().publish_request(request_message, request_destination, reply_timeout,
                                                          additional_message_properties)
        finally:
            with self._outstanding_requests_lock:
