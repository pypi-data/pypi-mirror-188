...
class Message(InteroperabilitySupport):
    ...
    def get_property(self, name: str) -> Union[str, int, float, bool, dict, list,
        ...
        Returns:
             str, int, float, bool, dict, list, bytearray, None: The value of the named property if found in the message otherwise, returns None.
        """
    ...
    def get_payload_as_dictionary(self) -> Union[Dict, None]:
        """
            ...
            PubSub+ messages can be published with a SDTMap payload. This is a platform-agnostic dictionary format
            that allows data types to be sent and received in messages that is independent of the publisher or consumer
            applications.

            Returns:
                dict : dictionary found in the payload or None if there is no payload, or the payload is not a dictionary
    ...
    def get_payload_as_list(self) -> Union[List, None]:
        """
            ...
            PubSub+ messages can be published with a SDTStream payload. This is a platform-agnostic list format
            that allows data types to be sent and received in messages that is independent of the publisher or consumer
            applications.
    ...
    def get_expiration(self) -> Union[int, None]:
        ...
        Returns:
            int :
              ...
              by the PubSub+ broker or None if it was not set.
        """
