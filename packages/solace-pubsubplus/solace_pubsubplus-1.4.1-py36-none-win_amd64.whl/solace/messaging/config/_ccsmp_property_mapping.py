...
from solace.messaging.config._sol_constants import SOLCLIENT_PROP_ENABLE_VAL, \
    ...
    SOLCLIENT_SESSION_PROP_SSL_EXCLUDED_PROTOCOLS, SOLCLIENT_SESSION_PROP_SSL_CONNECTION_DOWNGRADE_TO, \
    ...
    SOLCLIENT_TRANSACTEDSESSION_PROP_REQUESTREPLY_TIMEOUT_MS
