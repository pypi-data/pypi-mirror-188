...
class _SolaceMessage:
        ...
        if message_properties:
            for key, value in message_properties.items():
                ...
                if key in self._message_properties_mapping:
                    ...
                    return_code = self._message_properties_mapping[self._legacy_to_current_message_properties_mapping[key]](value)
    ...
    def get_message_class_of_service(self, cos_p):
        ...
        #
        # Parameters:
        #     msg_p   solClient_opaqueMsg_pt that is returned from a previous call to solClient_msg_alloc() or received in a receive message callback.
    ...
    def get_message_sender_id(self, buf_p):
        ...
        # Returns:
        #     SOLCLIENT_OK on success, SOLCLIENT_FAIL if msg is invalid, SOLCLIENT_NOT_FOUND if msg_contains no SenderId field.
    ...
    def transacted_send(self, transactedSession_p) -> int:
